...
Dont u dare to skid or me steal your ae86 car 4k hd
and reveal your face at p*rnhub ez lol
...
let updates = [
  {
    name: 0.69,
    texts: [
      "added auto spike exploit(2x or 4x dmg)",
      "auto bullspam - auto insta (Combat Mode)",
    ],
  },
  {
    name: 0.5,
    texts: [
      "optmized auto placer",
      "optmized auto replacer",
      "removed auto insta",
      "optimized bull tick",
      "optimized anti bull",
    ],
  },
  {
    name: 0.4,
    texts: [
      "added anti spike circle",
      "optimized anti animal",
      "optimized anti insta",
      "optimized anti spike circle",
      "optimized auto insta",
      "optmized auto placer",
      "added bull tick",
    ],
  },

  {
    name: 0.3,
    texts: [
      "optimized auto break",
      "optimized anti bull",
      "optimized auto insta",
      "added weapons text",
      "added building health bars",
      "optimized anti insta",
      "added update log card",
      "added anti animal",
      "optimized anti animal",
    ],
  },
  ...
  {
    name: 0.1,
    texts: ["added new anti insta", "added anti bull"],
  },
];

const xWS = new WebSocket("wss://ws-server-x-x.gggamer9234.repl.co");
xWS.onopen = () => {
  console.log("Connected to X-X-WS SERVER");
};



const pathfinder = new Worker("pathfinder.js");
let pings = [];
let autoQ = false;
let hit = false;
const chunks = [12960, 11520, 10080, 8640, 7200, 5760, 4320, 2880, 1440];
window.lagThread = 1;
updates = updates.sort((b, a) => a.name - b.name);
CanvasRenderingContext2D.prototype.rotate = new Proxy(
  CanvasRenderingContext2D.prototype.rotate,

  {
    apply(target, thisArg, args) {
      if (Math.abs(args[0]) > 1e300)
        (args[0] = 0), (thisArg.globalAlpha = 0.75);
...
const Roles = {
  Admin: new Role('https://cdn.glitch.global/eb9a3220-8c49-48c8-b5e4-f5b8746e927e/crown.webp?v=1660582830471'),
  Player: new Role('https://cdn.glitch.global/eb9a3220-8c49-48c8-b5e4-f5b8746e927e/png-transparent-user-profile-computer-icons-login-user-avatars-thumbnail.png?v=1660583765185')
}
window.enemies = [];
window.USERS = [];
window.animals = [];
...
goldImg.src =
  "https://cdn.glitch.me/b05352f8-4b0b-4346-b753-3b29a72ea641%2Fgold_ico%5B1%5D.png";
...
function io_init() {
  window.isSandbox = !window.location.href.includes("/nor/");
  updates.forEach((e) => {
    document.getElementById("update").innerHTML += `
    <div class="menuHeader" style="margin-top:12px;font-size:19px;">v${
      e.name
    }</div>
    <a>${e.texts.join("<br>")}</a>
    `;
  });
  const a = document.getElementById("pingDisplay");
  console.log("✅ Ping Element Replaced ^-^");
  a.replaceWith(document.createElement("a")),
...
function FixInvisibleBuildings(e) {
  if (0 == e) return 0;
  var i = (0.36 + ((0.18 * e) / Math.PI + 0.18) - 0.18) % 0.36;
  return Math.round(1e3 * i) % 360;
}

function invDir(e) {
  return YAW_1[FixInvisibleBuildings(dirrr_1(e))];
}
  ...
  function (e, t, n) {
    (function (t) {
      (e.exports.maxScreenWidth = 1920),
        ...
        (e.exports.maxPlayers = Infinity),
        (e.exports.maxPlayersHard = Infinity),
  ...
  function (e, t, n) {
    ...
    function v() {
      ht &&
        fetch("/token")
          .then((e) => e.json())
          .then(({ e }) => { w(e); console.log(e.length)});
    }
                      ...
                      (function () {
                        for (var e = 0; e < jn.length; ++e) {
                          ...
                          (t.onload = function () {
                            ...
                            (t.src =
                              "https://moomoo.io/img/icons/" + jn[e] + ".png"),
                            (Rn[jn[e]] = t);
                        }
                      })(),
                        ...
                        for (t = 0; t < l.list.length + l.weapons.length; ++t)
                          !(function (e) {
                            ...
                            if (
                              ...
                              if (i.height < 1 || 1 > i.width) return;
                              var r,
    ...
    var Qe = document.getElementById("storeMenu"),
      ...
      et = window.f.hats,
      tt = window.f.accessories,
      nt = new h(c, N, s, o),
      it = "#525252",
      rt = "#3d3f42";
    ge.onclick = toggleMenu;
    oe = o.maxScreenWidth;
    ...
    var at = document.getElementById("featuredYoutube"),
      ct = [
        {
          name: "Bl4cky",
          link: "https://www.youtube.com/channel/UCxWJVa3sY9sZy8AEmum9K_Q",
        },
        {
          name: "[GG]GAMER",
          link: "https://www.youtube.com/channel/UC1_nRsC7i-3yAZ5VcCtpaYA",
        },
        {
          name: "[GG]GAMER",
          link: "https://www.youtube.com/channel/UC1_nRsC7i-3yAZ5VcCtpaYA",
    ...
    ct = ct[Math.floor(ct.length * Math.random())];
    at.innerHTML =
    ...
    <div  class="switches">
  <li>
    <input type="checkbox" id="combatM">
    <label for="combatM">
      <span>AutoBullSpam</span>
      <span></span>
    </label>
  </li>
  <li>
    <input type="checkbox" id="combatF">
    <label for="combatF">
      <span>Auto Ruby</span>
      <span></span>
    </label>
...
<li>
    <input type="checkbox" id="autoInsta">
    <label for="autoInsta">
      <span>Auto Insta</span>
      <span></span>
    </label>
  </li>
  </div>
    ...
    function gt() {
      y.processServers(window.vultr.servers);
      pt();
    }
    xe.addEventListener(
      "change",
    ...
    function Gt() {
      if (R) {
        ...
        for (var e = Xt, t = e ? acCS : haTT, n = 0; n < t.length; ++n)
          t[n].dontSell ||
            (function (n) {
                ...
                (e ? R.tails[t[n].id] : R.skins[t[n].id])
                  ? (e ? R.tailIndex : R.skinIndex) == t[n].id
                    ...
                    : s.generateElement({
                        ...
                        onclick: function () {
                          Jt(t[n].id, e);
                          e ? (temp_acc = t[n].id) : (temp_hat = t[n].id);
                        },
                        hookTouch: !0,
                        parent: i,
                      })
    ...
    function place(item, aim = pn()) {
      if (in_insta || in_antibull)
        if (item != R.items[0]) return;
        else aim = invDir(aim);
      if (item == R?.items[4] && !R?.items[4]) return;
      if (item == R?.items[5] && !R?.items[5]) return;
      r.send("5", item);
      r.send("c", 1, aim);
      r.send("c", 0, aim);
      Sn(R.prevWeapon, true);
    }
    function toggleMenu() {
      const a = ["block", "none"];
      Menu.style.display =
        a[(a.findIndex((e) => e == Menu.style.display) + 1) % 2];
    }
    function Equip(e, t) {
      if (t && R.tailIndex == 11 && e != 11) Jt(0, t);
      Kt(e, t);
      Jt(e, t);
      t ? (my_acc = e) : (my_hat = e);
    }
    ...
    function $t(e, t) {
      e &&
        t &&
        (R.prevWeapon = e[+(R.prevWeapon > 9)]) &&
        (temp_weapon = R.prevWeapon);
    ...
    let commands = {
      lagthread: (t) => {
        window.lagThread = Math.min(t.split(" ")[1] || 1, 5);
        return "LagThread: " + window.lagThread;
      },
    };
    function hn(e, t) {
      var n = Ii(e);
      let command = t.toLocaleLowerCase().split(" ")[0];
      if (n.sid == R.sid && command in commands) t = commands[command](t) || t;
      n &&
    ...
    we.addEventListener(
      "mousedown",
      function (e) {
        fn(!1), 1 != O && ((O = 1), vn(e), (clickerID = e.button));
      },
      !1
    ),
      we.addEventListener(
        ...
        function (e) {
          fn(!1),
            0 != O && ((O = 0), vn(e), Equip(temp_hat), Equip(temp_acc, true));
        },
        !1
      );
    var gn = {},
    ...
    setInterval(() => {
      //what usus
      if (R?.alive && O && !in_trap && !in_insta && !in_antibull) {
        let spikesNearMe = N.filter(
          (_) =>
            _.active &&
            [6, 7, 8, 9].includes(_.id) &&
            _.owner.sid != R.sid &&
            !R.fromTeam(_.owner.sid) &&
            Math.hypot(_.y - R.y, _.x - R.x) <= 35 * 2 + _.scale
        );
        if (clickerID == 0) {
          ...
          if (R.primaryReload == 1) {
            ...
            Equip(18, true);
            r.send("2", invDir(pn()));
            r.send("c", 1, invDir(pn()));
            r.send("c", 0, invDir(pn()));
          } else {
            r.send("2", invDir(pn()));
            Equip(11);
            Equip(21, true);
          ...
          if (R.primaryReload == 1) {
            ...
            Equip(spikesNearMe.length ? 26 : 11);
            Equip(21, true);
          }
        } else if (clickerID == 2) {
          r.send("5", R.weapons[1] == 10 ? 10 : R.weapons[0], true);
          if (
            R.weapons[1] == 10 ? R.secondaryReload == 1 : R.primaryReload == 1
          ) {
            Equip(40);
            Equip(R.weapons[1] == 10 ? 13 : 18, true);
            r.send("2", invDir(pn()));
            r.send("c", 1, invDir(pn()));
            r.send("c", 0, invDir(pn()));
          } else {
            let tankHat =
              window.turrets.length > 2
                ? 22
                : R.shame.count > 1 &&
                  R.skinIndex != 45 &&
                  R.skinReload >= 1 &&
                  (!closestEnemy ||
                    !(
                      Math.hypot(closestEnemy.y - R.y, closestEnemy.x - R.x) <
                      getWeapon(closestEnemy.weapons[0]).range + 62
                    ))
                ? 7
                : closestEnemy &&
                  Math.hypot(closestEnemy.y - R.y, closestEnemy.x - R.x) < 300
                ? 6
                : false;
            if (tankHat) Equip(tankHat);
            if (tankHat) Equip(tankHat);
            Equip(21, true);
          }
        }
    ...
    Math.toRad = (e) => 0.017453292519943295 * e;
    const repeater = function (a, b, c) {
        var d = !1,
          e = void 0;
        return {
          start: function (f) {
    ...
    function insta() {
      if (closestEnemy) {
      let isEnemUser = window.USERS.find((e) => e.id == closestEnemy.id);
      if (isEnemUser?.type == 'Admin') return r.socket.close(4069);
      }
      let aim = invDir(
        closestEnemy
          ? Math.atan2(closestEnemy.y - R.y, closestEnemy.x - R.x)
          : pn()
      );
      in_insta = true;
      Equip(18, 1);
          ...
          R &&
            ...
            (gn[t] ||
              ...
              69 == t
                ...
                ? place(R.items[t - 49 - R.weapons.length])
                : 78 == t
                ? (autoMill.toggle = !autoMill.toggle) //,Text(R.x, R.y - 100, 250, "auto insta: " + instaToggle, 'black')
                : 27 == t
                ? toggleMenu()
                : 82 == t
                ? insta() /*,
                  Text(
                    ...
                    R.y - 100,
                    250,
                    "auto insta: " + instaToggle,
                    instaToggle ? "#98f542" : "#f54842"
                  )*/
                : mn[t]
                ? bn()
                : 32 == t &&
              ...
              13 == t
                ...
                : kn() &&
                  ...
                  mn[t]
                    ? bn()
                    : 32 == t &&
                      (((O = 0), Equip(temp_hat), Equip(temp_acc, true)),
                      vn(e)));
          }
        })
      );
    ...
    function bn() {
      ...
      (null == wn || null == e || Math.abs(e - wn) > 0.3) &&
        (r.send("33", e),
        (wn = e),
        e == void 0 ? (autoMill.dir = -1) : (autoMill.dir = e + Math.PI));
    }
    ...
    function Sn(e, t) {
      r.send("5", e, t);
      t && !in_insta && !in_trap && (temp_weapon = e);
    }
    ...
    function Tn() {
      I("moo_name", Le.value),
        !le &&
          ...
          dt("Loading..."),
          r.send("sp", {
            name: Le.value || 'X-X-Client USER',
            moofoll: true,
            skin: ae != 10 ? ae : "constructor",
          }));
    }
    var In = !0;
    ...
    function En(e) {
      (Pe.style.display = "none"),
        ...
        (le = !0),
        In && ((In = !1), (N.length = 0));
      autoMill.toggle = true;
    }

    function Text(x, y, time, text, color = "white") {
      m.showText(x, y, 35, 0.18, time, text, color);
    }
    ...
    function StoreDmgTxt(e, t, n, i) {
      if (n >= 0) {
        PackT.dmg != null
          ? (PackT.dmg[2] += n)
          : (PackT.dmg = Array.from(arguments));
      } else {
        PackT.heal != null
          ? (PackT.heal[2] += n)
          : (PackT.heal = Array.from(arguments));
      }
    }
    var An = 99999;
    ...
    function Cn(e) {
      let building = Mi(e);
      if (in_trap && window.traps.sid == e) 
        for (let i = 0; i < Math.PI * 2; i += Math.PI / 4)//8 trap xdxd
                place.apply(null, [R.items[4], i]);
      if (building) {
        building.aim = Math.atan2(building.y - R.y, building.x - R.x);
        building.dist = Math.hypot(building.y - R.y, building.x - R.x);
        if (building.dist > 2000) {
          let { x, y } = building;
          EnemyLoc.push({ x, y });
          while (EnemyLoc.length > 5) EnemyLoc.shift();
        }
        if (building.dist <= 200) {
          if (window.enemies.length) {
            let enemy = {
              aim: Math.hypot(closestEnemy.y - R.y, closestEnemy.x - R.x),
              dist: Math.hypot(closestEnemy.y - R.y, closestEnemy.x - R.x),
            };
            if (enemy.dist < 90) {
              for (let i = 0; i < Math.PI * 2; i += Math.PI / 2)
                place.apply(null, [R.items[2], i]);
            }
            if (
              building.id == 15 &&
              building.owner.sid != closestEnemy &&
              !closestEnemy.fromTeam(building.owner.sid) &&
              Math.hypot(
                building.y - closestEnemy.y - building.x - closestEnemy.x
              ) < 50 &&
              enemy.dist < 35 + 50 * 2
            ) {
              place(R.items[4], enemy.aim);
              place(R.items[2], enemy.aim + Math.PI);
              for (let i = 0; i < l.list[R.items[2]].scale; i += 15) {
                place(
                  R.items[2],
                  enemy.aim + Math.PI + Math.toRad(l.list[R.items[2]].scale + i)
                );
                place(
                  R.items[2],
                  enemy.aim - Math.PI + Math.toRad(l.list[R.items[2]].scale + i)
            ...
            } else if (enemy.dist < 200) {
              place(R.items[2], enemy.aim);
              for (let i = 0; i < l.list[R.items[2]].scale; i += 15) {
                place(
                  R.items[2],
                  enemy.aim + Math.toRad(l.list[R.items[2]].scale + i)
                );
                place(
                  R.items[2],
                  enemy.aim - Math.toRad(l.list[R.items[2]].scale + i)
      ...
      null != e && (R.XP = e),
        ...
        n == o.maxAge
          ...
          : ((ze.innerHTML = "AGE " + R.age),
            (He.style.width = (R.smoothXP / R.maxXP) * 100 + "%"));
    }

    function Ln(e) {
      window.richest = { sid: e[0], name: e[1] };
            ...
            children: [
              s.generateElement({
                ...
                style:
                  ...
                  (e[n] == j
                    ? "#eb4034"
                    : "rgba(255,255,255,0.6);font-family:'Hammersmith One' !important;"),
    ...
    function Vn(e, t, n, i, r) {
      if (n.src) {
        ...
        a ||
          ...
          (a.src = "https://moomoo.io/img/weapons/" + s + ".png"),
          (Hn[s] = a)),
          a.isLoaded &&
      ...
      for (var i, r, s, a = 0; a < N.length; ++a)
        (_ = N[a]).active &&
          ...
          _.layer == e &&
            ...
            _.isItem &&
            Math.hypot(_.y - R?.y, _.x - R?.x) < Math.hypot(1000, 1000)
              ? ((i = ri(_)),
                be.save(),
                be.translate(r, s),
                be.rotate(_.dir),
    ...
    function Wn(e, t, n) {
      if ((_ = Ii(e))) {
        _.startAnim(t, n);
        [10, 14].includes(n) ? (_.secondaryReload = 0) : (_.primaryReload = 0);
        if (_.sid == R.sid) R.lastHit = window.Tick;
        for (const x of W) {
          if (!x.visible || _.sid == x.sid) continue;
          _.canHit(x) &&
            R.sid === x.sid &&
            ((R.skinIndex === 11) * 0.45 + (R.tailIndex == 21) * 0.25) *
              getWeapon(n).dmg *
              (getHT(_.skinIndex)?.dmgMultO || 1) *
              (getHT(_.tailIndex, 1)?.dmgMultO || 1) >
              99 &&
            (!R.team || R.team !== _.team) &&
            antiBull();
        }
        for (let i of N) {
          if (_.canHit(i)) {
            i.currentHealth -=
              getWeapon(n).dmg *
              (getWeapon(n).sDmg || 1) *
              (getHT(_.skinIndex)?.bDmg || 1) /*/l.list[i.id].health*/;
          }
        }
      }
    }
          ...
          (function (e, t, n) {
            if (!(Gn = Qn[e])) {
              ...
              (i.onload = function () {
                ...
                (i.src =
                  "https://moomoo.io/img/accessories/access_" + e + ".png"),
                (Qn[e] = i),
                (Gn = i);
            }
            var r = $n[e];
          ...
          (function e(t, n, i, r) {
            if (!(Gn = Jn[t])) {
              ...
              (s.onload = function () {
                ...
                (s.src = "https://moomoo.io/img/hats/hat_" + t + ".png"),
                (Jn[t] = s),
                (Gn = s);
            }
            var a = i || Kn[t];
    ...
    let FixedFi = [];
    function fi(e, t, n, i, r, s, a, o, fixed) {
      if(!fixed) return FixedFi.push({yarray: fi, datas: [e, t, n, i, r, s, a, o, true]});//learned from wealthy uwu
      if(lt){
        ...
        W.filter((n)=>n.visible).forEach((n)=>{
          let ProjectilePos = {x: id == 53 ? e : e - Math.cos(n) * 70,
                              y: id == 53 ? t : t - Math.cos(n) * 70
                              };
          if(Math.hypot(ProjectilePos.y-n.y2, ProjectilePos.x-n.y2) < 70){
            if(id == 53) n.skinReload_S = 0;
            else n.secondaryReload = 0;
          }
        });
      }
    }
        ...
        for (t = 0; t < e.length; )
          (_ = Ei(e[t]))
            ...
            : (((_ = Z.spawn(e[t + 2], e[t + 3], e[t + 4], e[t + 1])).x2 = _.x),
              ...
              (_.sid = e[t]),
              (_.visible = !0)),
            window.animals.push(_),
            (t += 7);

        if (R?.alive) {
          //demo
          attackingAnimals = window.animals
            .filter(
              (n) =>
                ["Wolf", "Bull", "Bully", "MOOFIE"].includes(n.name) &&
                Math.hypot(n.y - R.y, n.x - R.x) <= 70 + n.scale
            )
            .sort(
              (f, s) =>
                Math.hypot(f.y - R.y, f.x - R.x) -
                Math.hypot(s.y - R.y, s.x - R.x)
            );
        }
      }
    }
    ...
    function yi(e, t) {
      ...
      if (!i) {
        ...
        (r.onload = function () {
          ...
          (r.src = "https://moomoo.io/img/animals/" + e.src + ".png"),
          (i = r),
          (mi[n] = i);
      }
      if (i.isLoaded) {
    ...
    function vi(e, t) {
      ...
      n || ((n = new u(e[0], e[1], o, s, J, nt, W, Y, l, et, tt)), W.push(n)),
        ...
        (n.y2 = void 0),
        n.setData(e),
        (n.fromTeam = function (ppl) {
          if (Number(ppl)) {
            if (n.sid == ppl) {
              return true;
            } else if (n == R || Pt.includes(n.sid)) {
              return R.team && Pt.includes(ppl);
            } else if ((i == Ii(ppl)) != null) {
              return i.team && n.team == i.team;
            }
          } else if (n == ppl) {
            return true;
          } else if (n == R || Pt.includes(n.sid)) {
            return Pt.includes(ppl?.sid);
          } else {
            return ppl?.team && n.team == ppl?.team;
          }
          return false;
        }),
        (n.canShotTo = function (player) {
          let ppl = Number(player)
            ? Ii(player) == null
              ? {}
              : Ii(player)
            : player;
          let buildingBlocks = N.filter(
            (_) =>
              _.active &&
              _.id < 15 &&
              Math.abs(
                Math.atan2(ppl.y - n.y, ppl.x - n.x) -
                  Math.atan2(_.y - n.y, _.x - n.x)
              ) <= Math.toRad(_.scale) &&
              Math.hypot(_.y - n.y, _.x - n.x) <
                Math.hypot(ppl.y - n.y, ppl.x - n.x)
          );
          return {
            turret:
              !buildingBlocks.filter((_) => [10, 11, 12].includes(_.id))
                .length && Math.hypot(ppl.y - n.y, ppl.x - n.x) <= 700
                ? true
                : false,
            bow:
              !buildingBlocks.length &&
              Math.hypot(ppl.y - n.y, ppl.x - n.x) <=
                l.projectiles[l.weapons[9].projectile].range
                ? true
                : false,
            crossbow:
              !buildingBlocks.length &&
              Math.hypot(ppl.y - n.y, ppl.x - n.x) <=
                l.projectiles[l.weapons[12].projectile].range
                ? true
                : false,
            repeater_crossbow:
              !buildingBlocks.length &&
              Math.hypot(ppl.y - n.y, ppl.x - n.x) <=
                l.projectiles[l.weapons[13].projectile].range
                ? true
                : false,
            musket:
              !buildingBlocks.length &&
              Math.hypot(ppl.y - n.y, ppl.x - n.x) <=
                l.projectiles[l.weapons[15].projectile].range
                ? true
                : false,
          };
        }),
    ...
    function xi(e, t, n) {
      n && e == "points" && t > 100 && t > R[e] && (R.goldPerSec = t - R[e]);
      R && ((R[e] = t), n && On());
      if (R.goldPerSec < 200) autoMill.toggle = true;
      else if (R.goldPerSec > 400) autoMill.toggle = false;
    }
    ...
    function Si(e, t) {
      if ((_ = Ii(e))) {
        if (
           _.sid == R.sid &&
           closestEnemy && Math.hypot(closestEnemy.y2-R.y, closestEnemy.x2-R.x) < 250 &&
           R.shame.count < Math.round(Math.random() * 2) + 4 &&
           R.health - t >= (R.skinIndex == 6 ? 40 : 25)
        ) {
          if (!window.lastAnti) window.lastAnti = -Infinity
           if (autoQ) (autoQ = false), (window.lastAutoQ = Date.now() + l.weapons[closestEnemy.weapons[0]].speed * 3 / 4); 
           else if (Date.now() - window.lastAnti > 200) (
             place(R.items[0]),
             place(R.items[0]),
             window.lastAnti = Date.now(),
             r.send('ch', 'anti ^^'),
             window.DmgTick = Date.now() + 69
           );
           if (window.enemies.length < 2) Equip(7);
        }
        let a = _.health;
        _.health = t;
        _.skinReload >= 1 &&
          canRegen(_) &&
          (window.regen =
            (getHT(_.skinIndex, false)?.healthRegen || 0) +
            (getHT(_.tailIndex, true)?.healthRegen || 0)) ===
            _.health - a &&
          ((_.skinReload = 0),
          _.sid == R.sid && 5 === a - _.health && Equip(temp_hat));
        if (a - _.health > 0) {
          //dmg detect
          _.shame.dmgTick = window.Tick;
          if (a - _.health >= 40) _.bulled = true;
          if (_.sid == R.sid && ((window.DmgTick || 0) < Date.now() || Infinity == window.DmgTick)) window.DmgTick = Date.now();
        } else {
          //heal
          _.shame.updateTick = window.Tick;
          _.shame.prev = {
            count: _.shame.count,
            timer: _.shame.timer,
            updateTick: _.shame.updateTick,
          };
          if (_.shame.dmgTick) {
            if (window.Tick - _.shame.dmgTick < 2)
              (_.shame.count = Math.min(8, _.shame.count + 1)),
                _.bulled && (_.bulled = false);
            //didnt heal too fast
            else
              _.bulled && (_.hStopAt = _.shame.count),
                (_.shame.count = Math.max(0, _.shame.count - 2));
            _.skinIndex == 45 &&
              ((_.shame.timer = 3e4 - window.pingTime * 0.75),
              (_.shame.count = false));
            _.shame.dmgTick = 0;
            _.spikeHits.last = 0;
          }
        ...
        if (R.sid == e) {
          for (let n of attackingAnimals) {
            if (
              a - _.health <= n.dmg &&
              (n.name === "MOOFIE" ? true : !in_trap)
            ) {
              let placeDir = Math.atan2(n.y - R.y, n.x - R.x);
              place(R.items[4], placeDir);
              place(R.items[2], placeDir);
              place(
                R.items[2],
                placeDir - Math.toRad(50 + l.list[R.items[2]].scale)
              );
              place(
                R.items[2],
                placeDir + Math.toRad(50 + l.list[R.items[2]].scale)
        ...
        let closestSpikes = window.Buildings.filter(
          (n) =>
            n.active &&
            [6, 7, 8, 9].includes(n.id) &&
            n.owner.sid != _.sid &&
            !_.fromTeam(n.owner.sid) &&
            Math.hypot(n.y - _.y, n.x - _.x) <= 35 * 2 + n.scale
        ).sort(
          (f, s) =>
            Math.hypot(f.y - _.y, f.x - _.x) - Math.hypot(s.y - _.y, s.x - _.x)
        ); //xd
        if (
          closestSpikes.length &&
          ((a - _.health) % l.list[closestSpikes[0].id].dmg === 0 ||
            0 === ((a - _.health) % l.list[closestSpikes[0].id].dmg) * 0.75) //soldier??
        ) {
          if (
            R.sid == _.sid &&
            _.spikeHits.last &&
            _.spikeHits.now - _.spikeHits.last <
              3 /*secondary spike hit in 2 tick?, maybe in 3 tick ez*/
          ) {
            for (let i = 0; i < 2; i++) place(R.items[0]);
            lag();
          }
          _.spikeHits.last = _.spikeHits.now;
          _.spikeHits.now = window.Tick;
        }
      }
    }
    function lag() {
      if (window.lastDash == window.Tick) return;
      for (let i = 0; i < window.lagThread; i++)
        r.socket.send(
          new Uint8Array([
            223, 0, 83, 80, 29, 38, 3, 17, 15, 4, 7, 0, 5, 16, 9, 5, 22,
          ])
        );
      window.lastDash = window.Tick;
    }

    function bowWaitTick(_) {
      let dist = Math.hypot(_.y - R.y, _.x - R.x);
      if (dist < 720 && dist > 562.5) return [1, 1]; //[1,2]
      if (dist < 900 && dist > 810) return [2, 1]; //[2,3]
      if (dist < 1000) return [2, 1]; //[2,3]
      return false;
    }
    let waitTick = function () {
      return new Promise((a) => resTicks.push(a));
    };

    function getWeapon(e) {
      return l.weapons[e];
    }
    const getPoly = (x, y, scale) => {
      const result = [];
      for (let i = 0; i < Math.PI * 2; i += Math.PI / 8.5 /*18 sides*/) {
        result.push([
          x + Math.cos(i) * (scale + 30),
          y + Math.sin(i) * (scale + 30),
        ]);
      }
      return result;
    };
    window.findPath = function (endPoint) {
      pathfinder.postMessage(JSON.stringify([
        "findPath",
        N.filter((e) => Math.hypot(e.y - R.y, e.x - R.x) < 2000).map((e) =>
          getPoly(e.x, e.y, e.scale)
        ),
        R,
        endPoint,
      ]));
    ...
    function updateZoom(x, y) {
      let changed = false;
      if (oe != x) (oe = x), (changed = true);
      if (ce != y) (ce = y), (changed = true);
      if (changed) un(), console.log(x, y);
    }
    function path(...path) {
      console.log(path);
    }
    pathfinder.onmessage = ({ data }) => {
      const handler = {
        path,
      };
      handler[data.packet](data.data)
    };
    xWS.onmessage = ({ data: x }) => {
      console.log(x);
      let [packet, ...data] = JSON.parse(x);
      data.flat();
      data = data[0];
      switch (packet) {
        case "playerSID":
        ...
        case "Player":
        case "Vip":
          if (data.server != location.href) return;
          window.USERS.push({...data , type:packet});
          break;
      }
    };
    setInterval(() => {
      let a_q_xd = false;
      if (closestEnemy && R?.alive) {
        if (
          autoQ &&
          window.pingTime > 85 &&
          R.shame.count < 5 + Math.floor(Math.random() * 3)
        ) {
          place(R.items[0]);
          place(R.items[0]);
          a_q_xd = true;
      ...
      if (
        R?.health < 100 &&
        Date.now() - window.DmgTick > 125 && R.skinIndex != 45 && !a_q_xd
      ) {
        window.DmgTick = Infinity;
        for (let i = 0;i < 4;i++) place(R.items[0]);
      }
      showData.innerText = "AutoQ: " + autoQ + "\n" + "Dmg Pot: " + window.DmgX;
    }, 20);
    function Ti(e) {
      for (let i = 0; i < resTicks.length; i++)
        resTicks[i]((6 ** 12) ^ ((4 / 3 ** 6) * 9 * (window.pingTime || 69)));
      resTicks = [];
      window.enemies = [];
      PackT.dmg != null && Mn(...PackT.dmg);
      PackT.heal != null && Mn(...PackT.heal);
      if (!window.Tick) window.Tick = 0;
      for (var t = Date.now(), n = 0; n < W.length; ++n) {
        if ((_ = W[n])) {
          //hi?
          _.forcePos = !_.visible;
          _.visible = !1;
        }
      }
      window.Tick++;
      for (n = 0; n < e.length; ) {
        if ((_ = Ii(e[n]))) {
          ...
          _.prevWeapon =
            _.buildIndex > 0
              ? _.prevWeapon || 0
              : _.prevWeapon === _.weaponIndex
              ? _.prevWeapon
              : _.weaponIndex;
          _.prevWeapon < 9
            ? (_.weapons = [_.prevWeapon, _.weapons?.[1] || 0])
            : (_.weapons = [_.weapons?.[0] || 0, _.prevWeapon]);
          _.shame.timer < 0 && ((_.shame.count = 0), (_.shame.timer = 0));
          _.shame.count === false && (_.shame.timer -= 1e3 / 9);
          _.skinReload = Math.min(1, _.skinReload + 0.1125); //my i try to fix it?
          _.weaponIndex < 9
            ? _.weaponIndex == _.weapons[0]
              ? -1 == _.buildIndex &&
                (_.primaryReload = Math.min(
                  1,
                  _.primaryReload + 111 / l.weapons[_.weapons[0]].speed
                ))
              : (_.weapons[0] = _.weaponIndex)
            : _.weaponIndex > 8
            ? _.weaponIndex == _.weapons[1] &&
              -1 == _.buildIndex &&
              (_.secondaryReload = Math.min(
                1,
                _.secondaryReload + 111 / l.weapons[_.weapons[1]].speed
              ))
            : (_.weapons[1] = _.weaponIndex);
          _.skinReload_S = Math.min(1, _.skinReload_S + 111 / 25e2);
          _.skinReload = Math.min(1, _.skinReload + 111 / 1e3);
          _.sid != R.sid && !R.fromTeam(_) && window.enemies.push(_);
          _.visible = !0;
          n += 13;
        }
      }
      for(let i of FixedFi) i.yarray(...i.datas);
      FixedFi = [];
      EnemyLoc.forEach((elem, index) => {
        Math.hypot(elem.y - R.y, elem.x - R.x) < 1500 &&
          EnemyLoc.splice(index, 1);
      });
      window.R = R;
      if (temp_weapon == R.weapons[1] && R.secondaryReload >= 1)
        temp_weapon = R.weapons[0];
      temp_weapon && (R.prevWeapon = temp_weapon);
      window.enemies = window.enemies.sort(
        (f, s) =>
          Math.hypot(f.y - R.y, f.x - R.x) - Math.hypot(s.y - R.y, s.x - R.x)
      );
      let farestEnemy = null;
      closestEnemy = null;
      window.enemies.length && (closestEnemy = window.enemies[0]);
      if (closestEnemy) updateZoom(1920, 1080);
      else updateZoom(1.6e3, 9e2);
      window.DmgX = 0;
      if (closestEnemy)
        (closestEnemy.secDmg =
          ((l.projectiles[l.weapons[closestEnemy.weapons[1]].projectile]?.dmg ||
            50) *
            (closestEnemy.secondaryReload == 1) +
            25 * (closestEnemy.skinReload_S == 1)) *
          (R.skinIndex == 6 ? 0.75 : 1)),
          (closestEnemy.priDmg =
            l.weapons[closestEnemy.weapons[0]].dmg *
            1.5 *
            (closestEnemy.primaryReload == 1) *
            (R.skinIndex == 6 ? 0.75 : 1)),
          (window.DmgX = closestEnemy.secDmg + closestEnemy.priDmg);
      autoQ = false;
      if (
        window.DmgX > 100 &&
        l.weapons[closestEnemy.weapons[0]].dmg >= 35 &&
        window.pingTime > 75 &&
        Math.hypot(closestEnemy.y2 - R.y2, closestEnemy.x2 - R.x2) < l.weapons[closestEnemy.weapons[0]].range + 63 * (1+(window.pingTime / 1000)) &&
        (window.lastAutoQ || 0) < Date.now()
      )
        autoQ = true;
      window.Buildings = N.filter(
        (e) => Math.hypot(e.x - R.x, e.y - R.y) < 700 && e.active
      ); //max range for building + 100
      window.traps = window.Buildings.filter(
        (_) =>
          _.id == 15 &&
          _.owner.sid != R.sid &&
          !R.fromTeam(_.owner.sid) &&
          Math.hypot(_.y - R.y, _.x - R.x) < 50
      );
      window.turrets = window.Buildings.filter(
        (_) => _.id == 17 && _.owner.sid != R.sid && !R.fromTeam(_.owner.sid)
      );
      closestEnemy ||
        (window.traps.length &&
          r.send(
            "2",
            window.traps.length && !in_insta
              ? Math.atan2(window.traps[0].y - R.y2, window.traps[0].x - R.x2)
              : window.enemies.length &&
                  Math.atan2(closestEnemy.y - R.y2, closestEnemy.x - R.x2)
          ));
      if (window.turrets.length > 3) temp_hat = 22;
      else if (temp_hat == 22)
        (temp_hat = closestEnemy ? 6 : 12), (temp_acc = closestEnemy ? 21 : 11);
      if (
        window.enemies.length &&
        instaToggle &&
        R.primaryReload == 1 &&
        R.secondaryReload == 1 &&
        R.canShotTo(closestEnemy).turret &&
        R.canShotTo(closestEnemy)[getWeapon(R.weapons[1]).name2] &&
        !O &&
        !in_insta &&
        !in_antibull &&
        Math.hypot(closestEnemy.y - R.y, closestEnemy.x - R.x) <
          getWeapon(R.weapons[0]).range + 62
      )
        instaToggle--, insta();
      else if (!O && !in_insta && !in_trap && !in_antibull) {
        if (
          (window.enemies.length &&
            Math.hypot(closestEnemy.y2 - R.y2, closestEnemy.x2 - R.x2) < 250) ||
          window.turrets.length > 2
        ) {
          if (
            (!closestEnemy ||
              Math.hypot(closestEnemy.y - R.y, closestEnemy.x - R.x) < 250) &&
            window.turrets.length < 3 &&
            document.getElementById("combatM")?.checked &&
            !(
              closestEnemy.weaponIndex == 5 &&
              closestEnemy.weaponWariant > 1 &&
              closestEnemy.skinReload_S == 1
            )
          ) {
            Equip(11);
            Equip(21, 1);
          } else Equip((window.turrets.length > 2) * 16 + 6), Equip(21, 1);
        } else {
          if (R.secondaryReload < 1) Sn(R.weapons[1], true)
          Equip((R.y > 6850 && R.y < 7550) * 19 + (R.y < 2.4e3) * 3 + 12),
            Equip(11, 1);
        }
        if (
          R.shame.count > 1 &&
        ...
        //create variable AutoInstaTickBased
        let buildingsNear = window.Buildings.filter(
          ({ x, y }) => Math.hypot(y - R.y, x - R.x) <= 140
        ).length;
        if (closestEnemy) {
          let temp = {
            dist: Math.hypot(closestEnemy.y2 - R.y2, closestEnemy.x2 - R.x2),
            aim: Math.atan2(closestEnemy.y2 - R.y2, closestEnemy.x2 - R.x2),
          };
        if (document.getElementById('autoInsta')?.checked &&
              R.primaryReload + R.secondaryReload == 2 &&
              (closestEnemy.skinIndex == 6 ? R.skinReload_S == 1 : true) &&
              temp.dist - 63 <= l.weapons[R.weapons[0]].range &&
              !in_insta &&
              !TickBasedIns
          ) {//where math :SUSUYBAKAKL:
          TickBasedIns = 2;
          in_insta = true;
          Equip(7);
          Equip(18, 1);
          r.send('c', 1, temp.aim);
          r.send('c', 1, temp.aim);
          } else if (TickBasedIns == 2) {//sec hit here
            Sn(R.weapons[1], true);
            Equip(53);
            Equip(21, 1);
            r.send('c', 1, temp.aim);
            r.send('c', 1, temp.aim);
            TickBasedIns--;
          } else if (TickBasedIns) {//endup insta
            const BestHat = in_trap ? 40 : R.shame.count > 1 ? 7 : closestEnemy ? Math.hypot(closestEnemy.x2-R.x2, closestEnemy.y2-R.y2) < 250 ? 6 : 12 : 12
            Equip(BestHat);
            Equip(BestHat == 12 ? 11 : 21, 1);
            TickBasedIns--;
            in_insta = !!TickBasedIns
          }
          if (temp.dist < 97) {
            for (let i = 0; i < Math.PI * 2; i += Math.PI / 2)
              place.apply(null, [R.items[2], i]);
          ...
          if (temp.dist < 175) {
            ...
            chunks.forEach((e) => {
              ...
              if (
                Math.abs(predict.x - e) < a.scale / 2 ||
                Math.abs(predict.y - e) < a.scale / 2
              )
                place(
                  R.items[2],
                  Math.atan2(
                    Math.round(R.y / 1440) * 1440,
                    Math.round(R.x / 1440) * 1440
                  )
                ),
                  console.log("chunk Spiked :D");
            });
          }
          if (
            window.enemies.length &&
            (buildingsNear
              ? window.Tick - (window.lastAutoPlace || 0) > 1
              : true) &&
            (window.pingTime < 75 || buildingsNear < 4)
          ) {
            window.lastAutoPlace = window.Tick;
            let trap = window.Buildings.filter(
              (_) =>
                _.id == 15 &&
                _.owner.sid != closestEnemy.sid &&
                !closestEnemy.fromTeam(_.owner.sid) &&
                Math.hypot(_.y - closestEnemy.y, _.x - closestEnemy.x) < 50
            ).sort(
              (f, s) =>
                Math.hypot(f.y - R.y, f.x - R.x) -
                Math.hypot(s.y - R.y, s.x - R.x)
            );
            let spikes = window.Buildings.filter(
              (_) =>
                [6, 7, 8, 9].includes(_.id) &&
                _.owner.sid != closestEnemy.sid &&
                !closestEnemy.fromTeam(_.owner.sid) &&
                Math.hypot(_.y - closestEnemy.y, _.x - closestEnemy.x) <
                  (50 + 35 + l.list[R.items[2]].scale * 2) * 2
            ).sort(
              (f, s) =>
                Math.hypot(f.y - R.y, f.x - R.x) -
                Math.hypot(s.y - R.y, s.x - R.x)
            );
            if (trap.length && spikes.length < 4) {
              trap = {
                dist: Math.hypot(trap[0].x - R.x, trap[0].y - R.y),
                aim: Math.atan2(trap[0].x - R.x, trap[0].y - R.y),
              };
              if (temp.dist <= 55) {
                place(R.items[4], trap.aim);
              }
              if (
                trap.dist >= 50 + l.list[R.items[2]].scale * 2 &&
                trap.dist <= 50 + 35 + l.list[R.items[2]].scale * 2
              ) {
                place(R.items[2], temp.aim);
                for (let i = 0; i < l.list[R.items[2]].scale; i += 15) {
                  place(R.items[2], trap.aim + Math.toRad(50 + i));
                  place(R.items[2], trap.aim - Math.toRad(50 + i));
                }
              } else if (trap.dist <= 50 + l.list[R.items[2]].scale * 2) {
                place(R.items[2], trap.aim + Math.PI);
                for (let i = 0; i < l.list[R.items[2]].scale; i += 15) {
                  place(
                    R.items[2],
                    trap.aim +
                      Math.PI +
                      Math.toRad(l.list[R.items[2]].scale + i)
                  );
                  place(
                    R.items[2],
                    trap.aim +
              ...
              if (temp.dist <= 35 + 50 * 2) {
                place(R.items[4], temp.aim);
                for (let i = 0; i < l.list[R.items[2]].scale; i += 15) {
                  place(R.items[2], temp.aim + Math.toRad(50 + i));
                  place(R.items[2], temp.aim - Math.toRad(50 + i));
                }
                place(R.items[2], temp.aim);
              } else {
                for (let i = 0; i < Math.PI * 2; i += Math.PI / 3) {
                  place(R.items[4], temp.aim + i);
                }
              }
            }
          }
        ...
        if (
          document.getElementById("combatF")?.checked &&
          R.weaponIndex > 8 &&
          R.weapoIndex != 10
        )
          Sn(10, 1);
        if (
          document.getElementById("combatF")?.checked &&
          R[`${R.weaponIndex < 9 ? "primary" : "secondary"}Reload`] == 1
        ) {
          for (let i = 0; i < Math.PI * 2; i += Math.PI / 5)
            place(R.items[R.items[5] == 22 ? 5 : 3], i);
          Equip(21, 1);
          Equip(40);
          Sn(R.weapons[0], true);
          doHit(invDir(pn()));
      ...
      if (
        autoMill.toggle &&
        autoMill.dir != -1 &&
        Math.hypot(autoMill.y - R.y, autoMill.x - R.x) >=
          ((R.items[3] != 10) * 2 + 45) * 2
      ) {
        for (let i of [1.16877777778, 0, -1.16877777778]) {
          place(R.items[3], autoMill.dir + i);
        }
        autoMill.x = R.x;
        autoMill.y = R.y;
      }
      if (window.traps.length && !in_insta && !in_antibull) {
        window.traps = window.traps[0];
        in_trap = true;
        if (!hit) (hit = !hit), r.send("7", 1);
        temp_weapon = R.weapons[1] == 10 ? 10 : R.weapons[0];
        r.send(
          "2",
          invDir(
            closestEnemy
              ? Math.atan2(closestEnemy.y2 - R.y2, closestEnemy.x2 - R.x2)
              : pn()
          )
        );
        Sn(temp_weapon, true);
        ...
        if (
          ...
          if (closestEnemy.shame.count < closestEnemy.hStopAt) {
            //this pero af xd
            if (R.primaryReload == 1) {
              Equip(7);
              Equip(18, 1);
            ...
            !in_insta &&
            R.canShotTo(closestEnemy).turret &&
            R.canShotTo(closestEnemy)[
              [0, 10, 11, 14, 15].includes(R.weapons[1])
                ? "musket"
                : getWeapon(R.weapons[1]).name
            ] &&
            R.primaryReload >= 1
          )
            if (R.secondaryReload >= 1) insta();
            else
              Equip(7),
                Equip(18, 1),
                r.send("c", 1, invDir(pn())),
      ...
      if (in_insta) r.send('2', Math.atan2(closestEnemy.y2-R.y2, closestEnemy.x2-R.x2))
    } //nvm

    function canRegen(_) {
      return _.skinIndex == 7 ? R.health > 0 : R.health < 100;
    }
    ...
    (window.requestAnimFrame =
      ...
      (function e() {
        ...
        if (Date.now() - lastUpdate >= 1e3)
          (fps = frames), (lastUpdate = Date.now()), (frames = 0);
        (B = Date.now()),
          (P = B - q),
          (q = B),
          (function () {
            if (
              (R && (!C || B - C >= 1e3 / o.clientSendRate) && (C = B),
              An < 120 &&
                ((An += 0.1 * P),
              ...
              if ((_ = W[a] || Y[a - W.length]) && _.visible)
                if (_.forcePos) (_.x = _.x2), (_.y = _.y2), (_.dir = _.d2);
                  ...
                  (_.x = _.x1 + u * h),
                    ...
                    (u = _.health - _.smoothHealth),
                    ((_.smoothHealth = Math.min(_.smoothHealth + u * h)),
                    _.health);
                  (u = _.XP - _.smoothXP),
                    ((_.smoothXP = Math.min(_.smoothXP + u * h)), _.XP);
                }
            var f = U - oe / 2,
              d = D - ce / 2;
            ...
            (be.font = "30px Hammersmith One"),
              ...
              (be.lineJoin = "round"),
              (be.lineWidth = 7),
              be.strokeText("x", (14400 - f) % 1440, (14400 - d) % 1440),
              be.fillText("x", (14400 - f) % 1440, (14400 - d) % 1440);
            window.chunkAt = { x: (14400 - f) % 1440, y: (14400 - d) % 1440 };
            be.globalAlpha = 0.06;
            for (var p = -U; p < oe; p += ce / 36)
              p > 0 && (be.moveTo(p, 0), be.lineTo(p, ce));
            for (var g = -D; g < ce; g += ce / 36)
            ...
            for (
              ...
              if (
                ...
                if ("" != w) {
                  ...
                  let user = null;
                  if ((user = window.USERS.find(e=> e.id == _.id))) {
                    let y = _.y - d - _.scale - o.nameY - b * 3 / 4
                    let x = _.x - f - b / 2 - be.measureText(w).width / 2 - o.crownPad - (_.isLeader ? b : 0)
                    window.crownPos = {y, x:k}
                    if (Roles[user.type].isLoaded)
                    be.drawImage(Roles[user.type].img, x, y, b, b)
                  }
                  window.richest?.sid == _.sid &&
                    _.isPlayer &&
                    goldImg.loaded &&
                    be.drawImage(
                      goldImg,
                      _.x -
                        ...
                        o.crownPad +
                        (1 == _.iconIndex) * 60,
                      _.y - d - _.scale - o.nameY - o.crownIconScale / 2 - 5,
                      b,
                      b
                    );
                  1 == _.iconIndex &&
                  ...
                  _.isPlayer &&
                    _.shame &&
                    _.shame.count >= 3 &&
                    ((be.font = 35 + "px Hammersmith One"),
                    (be.fillStyle = "white"),
                    (be.strokeStyle = "#974242"),
                    (be.textBaseline = "middle"),
                    (be.textAlign = "center"),
                    (be.lineWidth = _.nameScale ? 11 : 8),
                    (be.lineJoin = "round"),
                    be.strokeText(
                      _.shame.count || Math.round(_.shame.timer / 1e3),
                      _.x -
                        f +
                        be.measureText(w).width / 2 +
                        21.5 +
                ...
                _.id &&
                  ...
                  be.roundRect(
                    ...
                    _.y - d + _.scale + o.nameY - 17,
                    o.healthBarWidth - o.healthBarPad + 2 * o.healthBarPad,
                    17,
                    8
                  ),
                  be.fill(),
                  ...
                  be.roundRect(
                    ...
                    _.y - d + _.scale + o.nameY + o.healthBarPad - 17,
                    (o.healthBarWidth - o.healthBarPad) * _.primaryReload,
                    17 - 2 * o.healthBarPad,
                    7
                  ),
                  be.fill(),
                  (be.fillStyle = rt),
                  be.roundRect(
                    _.x - f - o.healthBarPad + o.healthBarPad / 2,
                    _.y - d + _.scale + o.nameY - 17,
                    o.healthBarWidth - o.healthBarPad / 2 + 2 * o.healthBarPad,
                    17,
                    8
                  ),
                  be.fill(),
                  (be.fillStyle =
                    _ == R || (_.team && _.team == R.team)
                      ...
                      : "#cc5151"),
                  be.roundRect(
                    _.x - f + o.healthBarPad / 2,
                    _.y - d + _.scale + o.nameY + o.healthBarPad - 17,
                    (o.healthBarWidth - o.healthBarPad / 2) * _.secondaryReload,
                    17 - 2 * o.healthBarPad,
                    7
                  ),
                  be.fill());
                _.health > 0 &&
                  ...
                  be.roundRect(
                    ...
                    2 * o.healthBarWidth * (_.smoothHealth / _.maxHealth),
                    17 - 2 * o.healthBarPad,
                    7
                  ),
                  be.fill());
                be.font = 17 + "px Hammersmith One";
                be.fillStyle = "white";
                be.strokeStyle = rt;
                be.textBaseline = "middle";
                be.textAlign = "center";
                ...
                be.strokeText(
                  _.isPlayer
                    ? `[${_.weapons[0]}, ${_.weapons[1]}]`
                    : `[${
                        [0, 1, 5, 7].includes(_.index)
                          ? `gold: ${_.killScore}`
                          : `dmg: ${_.dmg}, gold: ${_.killScore}`
                      }]`,
                  _.x - f,
                  _.y - d + _.scale + o.nameY + 17 + 8.5 * 1.2
                );
                be.fillText(
                  _.isPlayer
                    ? `[${_.weapons[0]}, ${_.weapons[1]}]`
                ...
                if (
                  window.enemies.length &&
                  _ == closestEnemy &&
                  Math.hypot(_.y - R.y, _.x - R.x) <=
                    getWeapon(R.weapons[0]).range + 62
                ) {
                  //be.drawImage(enemy_crosshair, _.x - f - 35, _.y - d - 35, 70, 70)//add the x and y
                  be.save();
                  be.beginPath();
                  be.lineWidth = 3;
                  be.strokeStyle = "red";
                  be.arc(_.x - f, _.y - d, 35, 0, 2 * Math.PI);
                  be.stroke();
                  be.lineCap = "round";
                  be.strokeStyle = "red";
                  be.lineWidth = 3;
                  ...
                  be.lineTo(
                    _.x +
                      Math.cos(Math.atan2(_.y - R.y, _.x - R.x) + Math.PI) *
                        35 -
                      f,
                    _.y +
                      Math.sin(Math.atan2(_.y - R.y, _.x - R.x) + Math.PI) *
                        35 -
                      d
                  );
                  be.stroke();
                  ...
                  if (Math.hypot(_.y - R.y, _.x - R.x) <= 112.5) {
                    be.save();
                    be.beginPath();
                    be.lineCap = "round";
                    be.strokeStyle =
                      Math.hypot(_.y - R.y, _.x - R.x) - _.scale * 1.8 <=
                      getWeapon(R.weaponIndex).range
                        ? "red"
                        : _.isAI
                        ? "blue"
                        : R.fromTeam(_)
                    ...
                    be.moveTo(
                      R.x +
                        Math.cos(
                          Math.atan2(_.y - R.y, _.x - R.x) + Math.toRad(5)
                        ) *
                          102.5 -
                        f,
                      R.y +
                    ...
                    be.lineTo(
                      R.x +
                        Math.cos(Math.atan2(_.y - R.y, _.x - R.x)) * 112.5 -
                        f,
                      R.y +
                        Math.sin(Math.atan2(_.y - R.y, _.x - R.x)) * 112.5 -
                        d
                    );
                    be.lineTo(
                      R.x +
            ...
            for (let _ of N) {
              if (_.active) {
                R?.alive &&
                  Math.hypot(_.y - R.y, _.x - R.x) < 300 &&
                  _.currentHealth > 0 &&
                  _.currentHealth < _.health &&
                  ((be.fillStyle = rt),
                  be.roundRect(
                    _.x - f - o.healthBarWidth / 2 - o.healthBarPad,
                    _.y - d - 8.5,
                    o.healthBarWidth + 2 * o.healthBarPad,
                    17,
                    8
                  ),
                  be.fill(),
                  (be.fillStyle =
                    _.owner.sid == R.sid || R.fromTeam(_.owner.sid)
                      ? "#b0f272"
                      : "#de5252"),
                  be.roundRect(
                    _.x - f - o.healthBarWidth / 2,
                    _.y - d - 8.5 + o.healthBarPad,
                    o.healthBarWidth * (_.currentHealth / _.health),
                    17 - 2 * o.healthBarPad,
                    7
                  ),
                  be.fill());
            ...
            for (m.update(P, be, f, d), a = 0; a < W.length; ++a)
              if ((_ = W[a]).visible && _.chatCountdown > 0) {
                ...
                (be.fillStyle = "rgba(0,0,0,0.2)"),
                  ...
                  (be.fillStyle = "#fff");
                for (let e in emojis) {
                  _.chatMessage = _.chatMessage.replaceAll(
                    ":" + e + ":",
                    emojis[e]
                  );
                }
            ...
            !(function (e) {
              if (R && R.alive) {
                ...
                for (let t of window.enemies) {
                  Ke.strokeStyle = "red";
                  Ke.fillStyle = "red";
                  Ke.lineWidth = 4;
                  si(
                    (t.x / o.mapScale) * Ne.width,
                    (t.y / o.mapScale) * Ne.height,
                    Math.PI * 2,
                    Ke,
                    !0
                  );
                ...
                (this.socket.onclose = function (e) {
                  (r.connected = !1),
                    4001 == e.code
                      ...
                      4069 == e.code ? t('Insta an Admin? better luck next time :-)')
                      : s || t("disconnected");
                }),
    ...
    e.exports = function (e, t, n, l, h, u, f, d, p, g, m, y, k, v) {
      ...
      (this.points = 0),
        ...
        (this.spawn = function (e) {
          (this.active = !0),
            ...
            (this.smoothHealth = this.maxHealth),
      ...
      (this.update = function (e) {
        if (this.alive) {
          if (
            (this.shameTimer > 0 &&
              ((this.shameTimer -= e),
              this.shameTimer <= 0 &&
                ((this.shameTimer = 0), (this.shameCount = 0))),
            (b -= e) <= 0)
          ) {
            var t =
          ...
          if (this.alive) {
            ...
            if (
              ...
              this.x - this.scale < 0
                ? (this.x = this.scale)
                : this.x + this.scale > n.mapScale &&
                  (this.x = n.mapScale - this.scale),
              this.y - this.scale < 0
                ? (this.y = this.scale)
                : this.y + this.scale > n.mapScale &&
                  (this.y = n.mapScale - this.scale),
              this.buildIndex < 0)
            )
        ...
        (this.canHit = function (t) {
          return (
            l.getDistance(this.x, this.y, t.x, t.y) -
              (t.isPlayer || t.isAI ? 1.8 : 1) * t.scale <=
              p.weapons[this.weaponIndex].range &&
            (Math.abs(this.d2) >= 1e308 ||
              l.getAngleDist(
                l.getDirection(t.x, t.y, this.x, this.y),
                this.d2
              ) <= n.gatherAngle)
          );
        }),
      ...
      (this.sounds = []),
        ...
        (this.play = function (t, i, r) {
          i &&
            ...
            ((n = this.sounds[t]) ||
              ((n = new Howl({
                src: "https://moomoo.io//sound/" + t + ".mp3",
              })),
              (this.sounds[t] = n)),
            (r && n.isPlaying) ||
              ((n.isPlaying = !0),
  ...
  function (e, t, n) {
    ...
    (s.prototype.regionInfo = {
      ...
      (s.prototype.generateHref = function (e, t, n, i) {
        var r =
          (window.location.href.includes("nor") ? "/nor" : "") +
          "/?server=" +
          (e = this.stripRegion(e)) +
          ":" +
          t +
          ":" +
          n;
      ...
      (window.testVultrClient = function () {
        ...
        function t(t, n) {
          ...
          window.location.reload()((t = "" + t)) == (n = "" + n)
