...
// @grant        none
// ==/UserScript==
// If you want you can edit bundle js
//
...
, function(e, t, n) {
    ...
    window.addEventListener("keydown", s.checkTrusted((function(e) {
        ...
        Mt.x = R.x,
        Mt.y = R.y) : 78 == t ? walkmillhaha = !walkmillhaha : 88 == t ? (R.lockDir = R.lockDir ? 0 : 1,
    ...
    let width;
    let height;
    var automillx = 10, automilly = 10, yooldx, yooldy, automill, walkmillhaha = false;
    function Ti(e) {
                    if(!automillx){
               automillx = R.x;
           }
