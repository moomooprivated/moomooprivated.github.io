...
CanvasRenderingContext2D.prototype.roundRect=new Proxy(CanvasRenderingContext2D.prototype.roundRect, {
    apply(target, that, args) {
        if (that.fillStyle == "#cc5151") {
            that.strokeStyle = that.fillStyle
            that.beginPath()
            that.moveTo(1920 / 2, 1080 / 2)
            that.lineTo(args[0] + 75, args[1])
            that.restore()
            that.stroke()
            ...
            that.beginPath();
            that.fillStyle = "cyan"
            that.arc(args[0] + 50, args[1] - 100, 7 ,0,Math.PI*2);
            that.closePath();
            that.fill();
        }
        return Reflect.apply(target, that, args);
...
var visuals = !1;
setInterval((() => {
        window.onbeforeunload = null, "disconnected\nreload" == document.getElementById("loadingText").innerText && (document.body.remove(), window.location.href = window.location.href)
    }), 0),
    function(e) {
        var t = {};
        ...
        function w() {
            mt && pt && (v = !0, i ? window.grecaptcha.execute("6LevKusUAAAAAAFknhlV8sPtXAk5Z5dGP5T2FYIZ", {
                action: "homepage"
            }).then((function(e) {
                k(e)
            })) : k(null))
        ...
        function k(e) {
            y.start((function(t, n, a) {
                ...
                e && (c += "&token=" + encodeURIComponent(e)), o.connect(c, (function(e) {
                    la(), setInterval((() => {
                    ...
                    })), s.hookTouchEvents(ye), ve.onclick = s.checkTrusted((function() {
                        Ae.classList.contains("showing") ? (Ae.classList.remove("showing"), we.innerText = "Settings") : (Ae.classList.add("showing"), we.innerText = "Close")
                    })), s.hookTouchEvents(ve), ke.onclick = s.checkTrusted((function() {
                        Ui(), "block" != Xe.style.display ? Ot() : Xe.style.display = "none"
                    })), s.hookTouchEvents(ke), be.onclick = s.checkTrusted((function() {
                        "block" != tt.style.display ? (tt.style.display = "block", Xe.style.display = "none", Ci(), Nt()) : tt.style.display = "none"
                    })), s.hookTouchEvents(be), xe.onclick = s.checkTrusted((function() {
                        Ei()
                    })), s.hookTouchEvents(xe), $e.onclick = s.checkTrusted((function() {
                        o.send("14", 1)
                    })), s.hookTouchEvents($e), function() {
                        for (var e = 0; e < Mo.length; ++e) {
                            var t = new Image;
                            t.onload = function() {
                                this.isLoaded = !0
                            }, t.src = ".././img/icons/" + Mo[e] + ".png", Eo[Mo[e]] = t
                        }
                    }(), Be.style.display = "none", Le.style.display = "block", Ye.value = C("moo_name") || "", function() {
                        var e = C("native_resolution");
                        Zt(e ? "true" == e : "undefined" != typeof cordova), S = "true" == C("show_ping"), Pe.hidden = !S, C("moo_moosic"), setInterval((function() {
                        ...
                        for (t = 0; t < l.list.length + l.weapons.length; ++t) ! function(e) {
                            ...
                            if (n.translate(t.width / 2, t.height / 2), n.imageSmoothingEnabled = !1, n.webkitImageSmoothingEnabled = !1, n.mozImageSmoothingEnabled = !1, l.weapons[e]) {
                                ...
                                var i = new Image;
                                Xo[l.weapons[e].src] = i, i.onload = function() {
                                    this.isLoaded = !0;
                                ...
                                i = Qo(l.list[e - l.weapons.length], !0);
        ...
        var P, S, L, A, B, _, O, R, j, D, U, z, W, Y, q = 0,
            ...
            ve = document.getElementById("settingsButton"),
            we = ve.getElementsByTagName("span")[0],
            ...
            Ke = document.getElementById("diedText"),
        ...
        $e.width = 300, $e.height = 300, ($e.style.backgroundImage = "url(https://i.imgur.com/S1ogeNC.gif)"), $e.style.backgroundSize = "130px", Pe.replaceWith(document.createElement("a")), Pe.style.fontSize = "20px", Pe.style.fontFamily = "Courier", Pe.style.display = "block", Pe.style.zIndex = "1", document.body.appendChild(Pe), setInterval((() => {
            Pe.style.display = fn ? "block" : "none"
        }), 0), Te.addEventListener("wheel", (function(e) {
            e.deltaY > 0 ? (he *= 1.05, ue *= 1.05) : (he /= 1.05, ue /= 1.05), Ai()
        }));
        ...
        var ht = document.getElementById("featuredYoutube"),
            ut = [{
                name: "VirusterDev",
                link: "https://www.youtube.com/@VirusterDev"
            }],
        ...
        function yt(e) {
            fe.style.display = "block", _e.style.display = "none", Le.style.display = "none", Ke.style.display = "none", Be.style.display = "block", Be.innerHTML = e + "<a href='javascript:window.location.href=window.location.href' class='ytLink'>reload</a>"
        }
                ...
                for (var u = 0; u < s.length; u++)
                    for (var d = s[u], f = 0; f < d.games.length; f++) {
                        var m = d.games[f],
                            ...
                            v = h + " " + p + " [" + Math.min(m.playerCount, r.maxPlayers) + "/40]";
                        let e = y.stripRegion(o) + ":" + u + ":" + f;
                        g && (ge.getElementsByTagName("span")[0].innerText = e), n += "<option value='" + e + "' " + (g ? "selected" : "") + ">" + v + "</option>"
                    }
        ...
        function wt() {
            ...
            e.onreadystatechange = function() {
                4 == this.readyState && (200 == this.status ? (window.vultr = JSON.parse(this.responseText), y.processServers(vultr.servers), vt()) : console.error("Failed to load server data with status code:", this.status))
        ...
        function Lt(e) {
            J.push(e), "block" == Xe.style.display && Ot()
        }

        function At(e, t) {
            O && (O.team = e, O.isOwner = t, "block" == Xe.style.display && Ot())
        }

        function Bt(e) {
            Ct = e, "block" == Xe.style.display && Ot()
        }

        function _t(e) {
            for (var t = J.length - 1; t >= 0; t--) J[t].sid == e && J.splice(t, 1);
            "block" == Xe.style.display && Ot()
        }

        function Ot() {
            if (O && O.alive) {
                if (Ci(), tt.style.display = "none", Xe.style.display = "block", s.removeAllChildren(Ge), O.team)
                    for (var e = 0; e < Ct.length; e += 2) ! function(e) {
                        var t = s.generateElement({
                            class: "allianceItem",
                            style: "color:" + (Ct[e] == O.sid ? "#fff" : "rgba(255,255,255,0.6)"),
                            text: Ct[e + 1] + " [" + Ct[e] + "]",
                            parent: Ge
                        });
                        O.isOwner && Ct[e] != O.sid && s.generateElement({
                            class: "joinAlBtn",
                            text: "Kick",
                            onclick: function() {
                                jt(Ct[e])
        ...
        function Rt(e) {
            o.send("11", Mt[0].sid, e), Mt.splice(0, 1), St()
        }
        ...
        window.isAlly = function(e) {
            for (let t = 0; t < Ct.length; t += 2)
                if (e == Ct[t]) return !0
        };
        var Wt, Yt = [];
        ...
        function qt(e, t) {
            for (var n = 0; n < Yt.length; ++n)
                ...
                this.init = function(e, t) {
                    ...
                    this.active && (this.scale += .05 * t, this.scale >= r.mapPingScale ? this.active = !1 : (e.globalAlpha = 1 - Math.max(0, this.scale / r.mapPingScale), e.beginPath(), e.arc(this.x / r.mapScale * $e.width, this.y / r.mapScale * $e.width, this.scale, 0, 2 * Math.PI), e.stroke()))
                }
            }, Yt.push(Wt)), Wt.init(e, t)
        }
        ...
        function Vt(e, t, n) {
            n ? e ? O.tailIndex = t : O.tails[t] = 1 : e ? O.skinIndex = t : O.skins[t] = 1, "block" == tt.style.display && Nt()
        }

        function Nt() {
            if (O) {
                s.removeAllChildren(nt);
                for (var e = Ft, t = e ? st : ot, n = 0; n < t.length; ++n) t[n].dontSell || function(n) {
        ...
        function Kt() {
            tt.style.display = "none", Xe.style.display = "none", Ci()
        }
        ...
        function Qt(e, t) {
            ...
            t && (Zs = Zs < 9 ? O.weapons[0] : O.weapons[1])
        }

        function Zt(e) {
            P = e, V = e && window.devicePixelRatio || 1, Me.checked = e, E("native_resolution", e.toString()), Ai()
        }
        ...
        var tn, nn, on, sn, an, rn, cn, ln = document.getElementById("chatBox"),
            hn = document.getElementById("chatHolder"),
            un = [],
            dn = [],
            fn = !1,
            mn = !1,
        ...
        function xi() {
            for (; hi.firstChild;) hi.removeChild(hi.firstChild);
            for (let e = 0; e < Sn.length; e += 2) {
                let t = document.createElement("div");
                t.style.fontSize = "20px", t.style.color = "#fff", t.innerText = ("~" == Sn[e] ? "" : Sn[e] + ": ") + Sn[e + 1], hi.appendChild(t)
            }
        }
        ...
        function Ei() {
            Pi ? setTimeout((function() {
                ...
                e && Mi(e)
            }), 1) : "block" == hn.style.display ? (ln.value && function(e) {
                let t = e.split(" ");
                if (t[0].charAt(0) == Fn) {
                    t[0] = t[0].substring(1);
                    try {
                ...
                return !0
            }(ln.value) && Mi(ln.value), ln.value.charAt(0) == Fn || Ci()) : (tt.style.display = "none", Xe.style.display = "none", hn.style.display = "block", ln.focus(), xi(), Ui()), ln.value = ""
        }
        ...
        function Ci() {
            ln.value = "", hn.style.display = "none"
        }
        ln.parentElement.prepend(hi), window.addCommand = function(e, t) {
            try {
                Xn[e.toLowerCase()] = t
            } catch (e) {
                return e
            ...
            1 == e[1].length ? !/[a-zA-Z]/.test(e[1]) && isNaN(e[1]) ? (Fn = e[1], returnMsg("Prefix is now '" + Fn + "'")) : returnMsg("'" + e[1] + "' cannot be alphabet/number") : returnMsg("'" + e[1] + "' is not a character")
            ...
            if (isNaN(e[1])) returnMsg("'" + e[1] + "' is not a id(number)");
                ...
                for (let t = 0; t < Nn.length; t++)
                    if (Nn[t] == e[1]) return void returnMsg("Alreadly ignoring player '" + e[1] + "'");
                Nn.push(e[1]), returnMsg("Now ignoring '" + e[1] + "'")
            }
        })), addCommand("listen", (function(e) {
            if (isNaN(e[1])) returnMsg("'" + e[1] + "' is not a id(number)");
            else {
                for (let t = 0; t < Nn.length; t++)
                    if (Nn[t] == e[1]) return returnMsg("Removed '" + e[1] + "' from ignored"), void Nn.splice(t, 1);
        ...
        function Li(e, t) {
            ...
            for (let t = 0; t < Nn.length; t++)
                if (Nn[t] == e) return;
            var n = na(e);
            n && (n.chatMessage = t, n.chatCountdown = r.chatCountdown, Ii(n.name + " [" + e + "]", t))
        }

        function Ai() {
            W = window.innerWidth, Y = window.innerHeight;
        ...
        function Bi(e) {
            (Pi = e) ? Ae.classList.add("touch"): Ae.classList.remove("touch")
        }

        function _i(e) {
            e.preventDefault(), e.stopPropagation(), Bi(!0);
            for (var t = 0; t < e.changedTouches.length; t++) {
                var n = e.changedTouches[t];
                n.identifier == re.id ? (re.id = -1, fo()) : n.identifier == ce.id && (ce.id = -1, O.buildIndex >= 0 && (_ = 1, Wi(e)), _ = 0, Wi(e))
            }
        }

        function Oi() {
            return O ? (-1 != ce.id ? Si = Math.atan2(ce.currentY - ce.startY, ce.currentX - ce.startX) : O.lockDir || Pi || (Si = Math.atan2(ae - Y / 2, se - W / 2)), s.fixTo(Si || 0, 2)) : 0
        }
        window.addEventListener("resize", s.checkTrusted(Ai)), Ai(), Bi(!1), window.setUsingTouch = Bi, Te.addEventListener("touchmove", s.checkTrusted((function(e) {
            e.preventDefault(), e.stopPropagation(), Bi(!0);
            for (var t = 0; t < e.changedTouches.length; t++) {
                var n = e.changedTouches[t];
                n.identifier == re.id ? (re.currentX = n.pageX, re.currentY = n.pageY, fo()) : n.identifier == ce.id && (ce.currentX = n.pageX, ce.currentY = n.pageY, _ = 1)
            }
        })), !1), Te.addEventListener("touchstart", s.checkTrusted((function(e) {
            e.preventDefault(), e.stopPropagation(), Bi(!0);
            for (var t = 0; t < e.changedTouches.length; t++) {
                var n = e.changedTouches[t];
                n.pageX < document.body.scrollWidth / 2 && -1 == re.id ? (re.id = n.identifier, re.startX = re.currentX = n.pageX, re.startY = re.currentY = n.pageY, fo()) : n.pageX > document.body.scrollWidth / 2 && -1 == ce.id && (ce.id = n.identifier, ce.startX = ce.currentX = n.pageX, ce.startY = ce.currentY = n.pageY, O.buildIndex < 0 && (_ = 1, Wi()))
            }
        })), !1), Te.addEventListener("touchend", s.checkTrusted(_i), !1), Te.addEventListener("touchcancel", s.checkTrusted(_i), !1), Te.addEventListener("touchleave", s.checkTrusted(_i), !1), Te.addEventListener("mousemove", (function(e) {
            e.preventDefault(), e.stopPropagation(), Bi(!1), e.isTrusted && (gn.x = e.clientX), e.isTrusted && (gn.y = e.clientY), se = e.clientX, ae = e.clientY, si && !H && (se = Zn - O.x2 + W / 2, ae = Qn - O.y2 + Y / 2), H && Ls.length && (se = Ls[1] - O.x2 + W / 2, ae = Ls[2] - O.y2 + Y / 2), Kn || ti || o.send("2", Oi()), si && (10 == O.weapons[1] ? ci[O.sid] < 1 : ri[O.sid] < 1) && !mn && !H && (se = gn.x, ae = gn.y, o.send("2", Oi()))
        ...
        function zi() {
            return "block" != Xe.style.display && "block" != hn.style.display
        }

        function Wi(e) {
            O && O.alive && 1 != e.button && o.send("c", _, O.buildIndex >= 0 ? Oi() : null), e.isTrusted ? 1 == e.button ? _ ? (Ri = e.button, Pn = !0) : Pn = !1 : _ ? (Ri = e.button, cn = setInterval((function() {
            ...
            }), 15), 0 == Ri && (Kn = 1), 2 == Ri && qn && (Kn = 1)) : (Kn = 0, clearInterval(cn)) : q || 8 == Zs || 11 == Zs || 14 == Zs || (Zs < 9 ? 1 == ri[O.sid] && (10 == O.weapons[1] && 2 == Ri ? (Zs = O.weapons[1], mo(O.weapons[1], 1)) : mo(O.weapons[0], 1), q++, o.send(7, 1), kn < 4 ? 2 == Ri ? Jt(40, 21) : 0 == Ri && Ls && 11 != Ls[9] ? (Gt(0, 1), Jt(7, 21)) : Jt(53, 21) : Jt(22, 11), setTimeout((function() {
                q--, o.send(7, 1)
            }), 120)) : Zs > 8 ? 1 == ci[O.sid] && (10 == O.weapons[1] && 0 == Ri ? (Zs = O.weapons[0], mo(O.weapons[0], 1)) : mo(O.weapons[1], 1), q++, o.send(7, 1), kn < 4 ? 10 == Zs ? Jt(40, 21) : 2 == Ri ? Jt(32, 21) : 0 == Ri && Jt(53, 21) : Jt(22, 11), setTimeout((function() {
                q--, o.send(7, 1)
            }), 120)) : 10 == O.weapons[0] && Ri ? (Zs = 10, mo(10, 1)) : (Zs = O.weapons[0], mo(O.weapons[0], 1)))
        }

        function Yi() {
            Yn && "chatbox" !== document.activeElement.id.toLowerCase() && (setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("We at the top again, now what?")
            }), 16e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Heavy lay the crown, but")
            }), 18e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Count us")
            }), 2e4), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Higher than the mountain")
            }), 21e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("And we be up here")
            }), 23e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("for the long run")
            }), 24e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Strap in for a long one")
            }), 25e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("We got everybody on one")
            }), 27e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Now you're coming at the king")
            }), 29e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("so you better not miss")
            }), 31e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("And we only get stronger")
            }), 33e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("With everthing I carry")
            }), 36e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("up on my back")
            }), 37e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("you should paint it up")
            }), 39e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("with a target")
            }), 41e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Why would you dare me to")
            }), 46e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("do it again?")
            }), 47e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Come get your spoiler up ahead")
            }), 5e4), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("We're taking over,")
            }), 53e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("We're taking over")
            }), 56e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Look at you come at my name,")
            }), 61e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("you 'oughta know by now,")
            }), 63e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("That We're Taking Over,")
            }), 66e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("We're Taking Over")
            }), 69e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Maybe you wonder what")
            }), 74e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("you're futures gonna be, but")
            }), 75e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("I got it all locked up")
            }), 77e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Take a lap, now")
            }), 93e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Don't be mad, now")
            }), 95e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Run it back, run it back,")
            }), 97e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("run it back, now")
            }), 98e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("I got bodies lining up,")
            }), 1e5), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("think you're dreaming")
            }), 101e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("of greatness")
            }), 102e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Send you back home,")
            }), 103e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("let you wake up")
            }), 105e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Why would you dare me to")
            }), 11e4), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("do it again?")
                ...
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("After all, what still exists")
            }), 157e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("except for fights")
            }), 158e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Around me,")
            }), 16e4), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("the keyboard is clicking,")
            }), 161e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("the clock is ticking")
            }), 162e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Still not enough, let me")
            }), 164e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("protect your persistence")
            }), 165e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Do not worry about the future")
            }), 166e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("even if itÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¾Ãƒâ€šÃ‚Â¢s too late")
            }), 167e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Let out the fight,")
            }), 168e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("right at this moment")
            }), 169e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("I got the heart of lion")
            }), 17e4), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("I know the higher you climbing")
            }), 171e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("the harder you fall")
            }), 172e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("I'm at the top of the mount")
            }), 173e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Too many bodies to count,")
            }), 174e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("I've been through it all")
            }), 175e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("I had to weather the storm")
            }), 176e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("to get to level I'm on")
            }), 178e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("That's how the legend was born")
            }), 179e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("All of my enemies already dead")
            }), 18e4), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("I'm bored, I'm ready for more")
            }), 182e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("They know I'm ready for war")
            }), 183e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("I told em")
            }), 184e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("We're Taking Over,")
            }), 185e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("We're Taking Over")
        ...
        function qi() {
            Yn && "chatbox" !== document.activeElement.id.toLowerCase() && (setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("I love you so much")
            }), 13e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("I am a registered s*x offender")
            }), 16e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("I stuck my d*ck into a blender")
            }), 18e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Your mom is a transgender")
            }), 2e4), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("I am a professional")
            }), 22e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("nude sender")
            }), 23e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("You know that I be dominating")
            }), 24e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("My c*ck and balls are rotating")
            }), 26e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Ice on my wrist,")
            }), 28e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("I could go skating")
            }), 29e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Between thick thighs,")
            }), 3e4), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("I'm suffocating")
            }), 31e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("I have a huge f*cking c*ck")
            }), 32e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("I nut inside of my sock")
            }), 34e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("I walk around in crocks")
            }), 36e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("While my d*ck is harder")
            }), 38e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("than a rock")
            }), 39e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("I f*ck b*tches in school")
            }), 4e4), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Cause you know")
            }), 42e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("I'm fucking cool")
            }), 43e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("I jump inside of my pool")
            }), 44e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("I take a hit from juul")
            }), 46e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("I don't actually smoke")
            }), 48e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("But it'd make your b*tch choke")
            }), 5e4), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Once I give someone a stroke")
            }), 52e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("My c*ck is hard like oak")
            }), 54e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("You know I'm dropping fire")
            }), 56e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("You could sing my songs")
            }), 58e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("the the choir")
            }), 59e4), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("They call me Quagmire")
            }), 6e4), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("No they don't but")
            }), 62e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("at least it rhymes")
            }), 63e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Ay!")
            }), 64e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Alright everyone,")
            }), 66e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("sing along for this next part!")
            }), 67e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("I nutted inside you mooo-ooom")
            }), 72e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Yeah!")
            }), 76e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Ay!")
            }), 78e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("I nutted inside you mooo-ooom")
            }), 8e4), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Woooh!")
            }), 84e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Alright, here we go!")
            }), 86e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("I love you so much")
            }), 93e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("AY AY AY AY!")
            }), 94e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("You know I love being a s*xist")
            }), 96e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("I eat p*ssy for breakfast")
            }), 98e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Ice on my necklace")
            }), 1e5), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("I had s*x with my dentist")
            }), 102e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("My fanbase is getting bigger")
            }), 104e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Your hoe is a gold digger")
            }), 106e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("I wear Tommy Hilfiger")
            }), 108e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("While I pull on the trigger")
            }), 11e4), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Woah, woah, woah")
            }), 112e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("that was risky")
            }), 113e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("My b*tch just turned 60")
            }), 114e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("She knows my c*m is sticky")
            }), 116e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("But her p*ssy is squeaky")
            }), 118e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("like Mickey")
            }), 119e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("My lines are hotter")
            }), 12e4), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("than the stars")
            }), 121e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("When I'm dropping")
            }), 122e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("these crazy bars")
            }), 123e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("My c*m has filled jars")
            }), 124e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("And stained so many cars")
            }), 126e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Ay")
            }), 129e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && qi()
            }), 153e3))
        }

        function Hi() {
            Yn && "chatbox" !== document.activeElement.id.toLowerCase() && (setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("As a child you would wait")
            }), 6e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("And watch from far away")
            }), 9e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("But you always knew")
            }), 12e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("that you'd be the one")
            }), 14e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("That work while they all play")
            }), 15e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("In youth you'd lay")
            }), 18e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Awake at night and scheme")
            }), 21e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Of all the things")
            }), 24e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("that you would change")
            }), 26e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("But it was just a dream")
            }), 27e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Here we are,")
            }), 31e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Don't turn away now")
            }), 33e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("We are the warriors")
            }), 37e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("that built this town")
            }), 39e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Here we are")
            }), 43e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Don't turn away now")
                ...
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("From dust")
            }), 55e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("The time will come")
            }), 57e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("When you'll have to rise")
            }), 58e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Above the best")
            }), 61e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("and prove yourself")
            }), 63e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Your spirit never dies")
            }), 64e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Farewell, I've gone")
            }), 67e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("to take my throne above")
            }), 71e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("But don't weep for me")
            }), 73e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("'Cause this will be")
            }), 75e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("The labor of my love")
            }), 77e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Here we are,")
            }), 8e4), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Don't turn away now")
                ...
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Hi()
            }), 17e4))
        }

        function Fi() {
            Yn && "chatbox" !== document.activeElement.id.toLowerCase() && (setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Legends never die")
            }), 12e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("when the world is calling you")
            }), 16e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Can you hear them")
            }), 19e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("screaming out your name?")
            }), 21e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Legends never die")
            }), 25e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("they become a part of you")
            }), 29e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Every time you bleed")
            }), 33e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("for reaching greatness")
            }), 35e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Relentless you survive")
            }), 39e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("They never lose hope")
            }), 43e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("when everything's cold")
            }), 45e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("and the fighting's near")
            }), 47e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("It's deep in their bones")
            }), 5e4), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("they run into smoke")
            }), 52e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("when the fire is fierce")
            }), 54e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("'Oh pick yourself up, cause")
            }), 57e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Legends never die")
            }), 6e4), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("when the world is calling you")
                ...
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("They're written down")
            }), 91e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("in eternity")
            }), 92e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("But you'll never see")
            }), 94e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("the price it costs,")
            }), 97e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("the scars collected")
            }), 1e5), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("all their lives")
            }), 102e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("When everything's lost")
            }), 105e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("they pick up their hearts")
            }), 107e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("and avenge defeat")
            }), 109e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Before it all starts,")
            }), 112e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("they suffer through harm")
            }), 114e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("just to touch a dream")
            }), 115e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("'Oh pick yourself up, cause")
            }), 118e3), setTimeout((() => {
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Mi("Legends never die")
                ...
                Yn && "chatbox" !== document.activeElement.id.toLowerCase() && Fi()
            }), 178e3))
        }

        function Vi() {
            Yn && setTimeout((() => {
                Yn && (Mi("No there ain't no stopping us."), setTimeout((() => {
                    Yn && (Mi("Fly without boarding pass."), setTimeout((() => {
                        Yn && (Mi("Couldn't catch me"), setTimeout((() => {
                            Yn && (Mi("I be moving fast."), setTimeout((() => {
                                Yn && (Mi("Call me a shooting star."), setTimeout((() => {
                                    Yn && (Mi("Lend all you are."), setTimeout((() => {
                                        Yn && (Mi("Flyin' up in a bar."), setTimeout((() => {
                                            Yn && (Mi("Wish on a star."), setTimeout((() => {
                                                Yn && (Mi("Time to show' em"), setTimeout((() => {
                                                    Yn && (Mi("who's in charge"), setTimeout((() => {
                                                        Yn && (Mi("Call me a shooting star."), function() {
                                                            if (!Yn) return;
                                                            setTimeout((() => {
                                                                Yn && (Mi("Shootin' stars!"), setTimeout((() => {
                                                                    Yn && (Mi("Didn't even get to guns"), setTimeout((() => {
                                                                        Yn && (Mi("I said I'm moving to fast!"), setTimeout((() => {
                                                                            Yn && (Mi("Get to guns"), setTimeout((() => {
                                                                                Yn && (Mi("You lookin' at shooting star."), setTimeout((() => {
                                                                                    Yn && (Mi("Got more than a couple"), setTimeout((() => {
                                                                                        Yn && (Mi("of people going mad"), setTimeout((() => {
                                                                                            Yn && (Mi("I swear they're rooting hard."), setTimeout((() => {
                                                                                                Yn && (Mi("To the my be big in the game"), setTimeout((() => {
                                                                                                    Yn && (Mi("now she went and"), function() {
                                                                                                        if (!Yn) return;
                                                                                                        setTimeout((() => {
                                                                                                            Yn && (Mi("got them breast implants."), setTimeout((() => {
                                                                                                                Yn && (Mi("I said I'm moving to fast,"), setTimeout((() => {
                                                                                                                    Yn && (Mi("didn't even get to guns!"), setTimeout((() => {
                                                                                                                        Yn && (Mi("I'm ready to eat up track like"), setTimeout((() => {
                                                                                                                            Yn && (Mi("I'm seated in a restaurant."), setTimeout((() => {
                                                                                                                                Yn && (Mi("If you had like swag like mine"), setTimeout((() => {
                                                                                                                                    Yn && (Mi("you'd know it's best to flaunt."), setTimeout((() => {
                                                                                                                                        Yn && (Mi("We are, hey in"), setTimeout((() => {
                                                                                                                                            Yn && (Mi("because you aren't."), setTimeout((() => {
                                                                                                                                                Yn && (Mi("Shining like Disney & Young."), function() {
                                                                                                                                                    if (!Yn) return;
                                                                                                                                                    setTimeout((() => {
                                                                                                                                                        Yn && (Mi("Drop like Kings of Leon."), setTimeout((() => {
                                                                                                                                                            Yn && (Mi("Shooting stars"), setTimeout((() => {
                                                                                                                                                                Yn && (Mi("across the galaxy."), setTimeout((() => {
                                                                                                                                                                    Yn && (Mi("I stand out so"), setTimeout((() => {
                                                                                                                                                                        Yn && (Mi("don't be mad at me."), setTimeout((() => {
                                                                                                                                                                            Yn && (Mi("Infiltration win my strategy."), setTimeout((() => {
                                                                                                                                                                                Yn && (Mi("When I turn up they"), setTimeout((() => {
                                                                                                                                                                                    Yn && (Mi("gonna just have to leave."), setTimeout((() => {
                                                                                                                                                                                        Yn && (Mi("Shooting stars"), setTimeout((() => {
                                                                                                                                                                                            Yn && (Mi("across the galaxy."), setTimeout((() => {
                                                                                                                                                                                                Yn && (Mi("I stand out so"), function() {
                                                                                                                                                                                                    if (!Yn) return;
                                                                                                                                                                                                    setTimeout((() => {
                                                                                                                                                                                                        Yn && (Mi("don't be mad at me."), setTimeout((() => {
                                                                                                                                                                                                            Yn && (Mi("Infiltration win my strategy."), setTimeout((() => {
                                                                                                                                                                                                                Yn && (Mi("When I turn up they"), setTimeout((() => {
                                                                                                                                                                                                                    Yn && (Mi("gonna just have to leave."), setTimeout((() => {
                                                                                                                                                                                                                        Yn && (Mi("Yao, yao, yao"), setTimeout((() => {
                                                                                                                                                                                                                            Yn && (Mi("Shoot, shoot, shoot"), setTimeout((() => {
                                                                                                                                                                                                                                Yn && (Mi("Yao, yao, yao"), setTimeout((() => {
                                                                                                                                                                                                                                    Yn && (Mi("Shoot, shoot, shoot"), setTimeout((() => {
                                                                                                                                                                                                                                        Yn && (Mi("Yao, yao, yao"), setTimeout((() => {
                                                                                                                                                                                                                                            Yn && (Mi("Shootin', shootin', shootin'"), setTimeout((() => {
                                                                                                                                                                                                                                                Yn && (Mi("Yao, yao, yao"), function() {
                                                                                                                                                                                                                                                    if (!Yn) return;
                                                                                                                                                                                                                                                    setTimeout((() => {
                                                                                                                                                                                                                                                        Yn && (Mi("Shootin' shots!"), setTimeout((() => {
                                                                                                                                                                                                                                                            Yn && (Mi("Shooting stars!"), setTimeout((() => {
                                                                                                                                                                                                                                                                Yn && (Mi("Shooting stars!"), setTimeout((() => {
                                                                                                                                                                                                                                                                    Yn && (Mi("Shooting stars!"), setTimeout((() => {
                                                                                                                                                                                                                                                                        Yn && (Mi("Shooting stars!"), setTimeout((() => {
        ...
        var Ni = [4e306, 8e305, 6e306, 8e302, 4e304, 5e303, 5e306, 1e308, 2e306, 4e305, 3e306, 3e304, 12999999999999997e292, 6e305, 1e307, 7e304];
        ...
        function Xi(e, t) {
            ...
            for (let t = -180; t < 180; t += 22.5)
                if (e == t) {
                    t < 0 && (t += 360), n = Ni[t / 22.5]
                } 20 != t ? (mo(O.items[t]), o.send("c", 1, n), o.send("c", 0, n), mo(Zs, 1)) : (mo(20), o.send("c", 1, n), o.send("c", 0, n), mo(Zs, 1))
        }
        var Gi = {
                Shift: 0,
                z: 40,
            ...
            Ji = 0,
            $i = [11, 13, 21, 18],
            Ki = [6, 7, 12, 15, 22, 31, 40, 53, 11],
            Qi = [4e306, 6e306, 1e306, 5e306, 2e306, 3e306, 12999999999999997e292, 1e307],
            Zi = Xt("v", (() => {
                if (ui) {
                    let e = Oi();
                    e = Math.round(e / Math.PI * 8) * Math.PI / 8, Xi(e, 2)
                } else mo(O.items[2]), o.send("c", 1, Oi), o.send("c", 0, Oi), mo(Zs, 1)
            }), 10),
            eo = Xt("q", (() => {
                mo(O.items[0]), o.send("c", 1, Oi), o.send("c", 0, Oi), mo(Zs, 1)
            }), 10),
            to = Xt("h", (() => {
                if (mi)
                    if (vi)
                        for (let e = 0; e < 8; e++) mo(O.items[5]), o.send("c", 1, Qi[e]), o.send("c", 0, Qi[e]), mo(Zs, 1);
                    else {
                        let e = Oi();
                        e = Math.round(e / Math.PI * 8) * Math.PI / 8, Xi(e, 5)
                    }
                else if (vi)
                    for (let e = 0; e < 2 * Math.PI; e += Math.PI / 6) mo(O.items[5]), o.send("c", 1, e), o.send("c", 0, e), mo(Zs, 1);
                else mo(O.items[5]), o.send("c", 1, Oi), o.send("c", 0, Oi), mo(Zs, 1)
            }), 10),
            no = Xt("w", (() => {
                Dn++, setTimeout((() => {
                    Dn--
            ...
            co = Xt("l", (() => {
                if (fi)
                    if (gi)
                        for (let e = 0; e < 8; e++) mo(20), o.send("c", 1, Qi[e]), o.send("c", 0, Qi[e]), mo(Zs, 1);
                    else {
                        let e = Oi();
                        e = Math.round(e / Math.PI * 8) * Math.PI / 8, Xi(e, 20)
                    }
                else if (gi)
                    for (let e = 0; e < 2 * Math.PI; e += Math.PI / 12) mo(20), o.send("c", 1, e), o.send("c", 0, e), mo(Zs, 1);
                else mo(20), o.send("c", 1, Oi), o.send("c", 0, Oi), mo(Zs, 1)
            }), 50),
            lo = Xt("f", (() => {
                if (di)
                    if (pi)
                        for (let e = 0; e < 8; e++) mo(O.items[4]), o.send("c", 1, Qi[e]), o.send("c", 0, Qi[e]), mo(Zs, 1);
                    else {
                        let e = Oi();
                        e = Math.round(e / Math.PI * 8) * Math.PI / 8, Xi(e, 4)
                    }
                else if (pi)
                    for (let e = 0; e < 2 * Math.PI; e += Math.PI / 10) mo(O.items[4]), o.send("c", 1, e), o.send("c", 0, e), mo(Zs, 1);
                else mo(O.items[4]), o.send("c", 1, Oi), o.send("c", 0, Oi), mo(Zs, 1)
            }), 50),
            ho = Xt("c", (() => {
                let e = Oi();
                e = Math.round(e / Math.PI * 8) * Math.PI / 8, Xi(e)
            }), 50);
        window.addEventListener("keydown", s.checkTrusted((function(e) {
            var t = e.which || e.keyCode || 0;
            109 == t && (ai ? (clearInterval(sn), ai = !1, Gn = 0, Jn = 0, he = 1920, ue = 1080, Ai()) : (sn = setInterval((function() {
                void 0 !== on && (Gn += 10 * Math.cos(on), Jn += 10 * Math.sin(on))
            })), ai = !0)), 27 == t ? Kt() : O && O.alive && zi() && (ji[t] || (ji[t] = 1, 69 == t ? o.send("7", 1) : 67 == t ? (Et || (Et = {}), Et.x = O.x, Et.y = O.y) : 88 == t ? (O.lockDir = O.lockDir ? 0 : 1, o.send("7", 0)) : null != O.weapons[t - 49] ? (mo(O.weapons[t - 49], !0), Zs = O.weapons[t - 49]) : null != O.items[t - 49 - O.weapons.length] ? mo(O.items[t - 49 - O.weapons.length]) : 81 == t ? mo(O.items[0]) : Di[t] ? Tn ? (Mi("turn off autogrind first"), o.send("33", null)) : fo() : 78 == t ? ro = !ro : 71 == t ? Js(1) : 32 == t && (_ = 1, Wi(e)), "Alt" == e.key && o.send(new Uint8Array([900, 500, 400, 600, 300, 162, 700, 800, 1e3, 223, 1, 13, 113, 180, 79, 68, 172, 341])), "k" == e.key && (pn = !pn, Mi("ckt")), ";" == e.key && (Yn = !Yn, Yi()), "-" == e.key && (Yn = !Yn, qi()), "=" == e.key && (Yn = !Yn, Hi()), "'" == e.key && (Yn = !Yn, Fi()), "]" == e.key && (Yn = !Yn, Vi()), "/" == e.key && (On = !On), Zi.start(e.key), eo.start(e.key), to.start(e.key), co.start(e.key), lo.start(e.key), ao.start(e.key), no.start(e.key), io.start(e.key), oo.start(e.key), so.start(e.key), ho.start(e.key), null != Gi[e.key] && ("block" == tt.style.display ? Gi[e.key] ? Gt(Gi[e.key]) : O.y2 < 2400 ? Jt(15, 11) : O.y2 > 6850 && O.y2 < 7550 ? Jt(31, 11) : Jt(12, 11) : Ji = Gi[e.key])))
        }))), window.addEventListener("keyup", s.checkTrusted((function(e) {
            if (O && O.alive) {
                var t = e.which || e.keyCode || 0;
                13 == t ? Ei() : zi() && ji[t] && (ji[t] = 0, Di[t] ? fo() : 71 == t ? Js(0) : 32 == t && (_ = 0, Wi(e)), Zi.stop(e.key), eo.stop(e.key), to.stop(e.key), co.stop(e.key), lo.stop(e.key), ao.stop(e.key), no.stop(e.key), io.stop(e.key), oo.stop(e.key), so.stop(e.key), ho.stop(e.key))
            }
        }))), setInterval((() => {
            O && O.points != rn && _n && (function() {
                for (let e = 0; e < Ki.length; e++) $t(Ki[e], !1);
                for (let e = 0; e < $i.length; e++) $t($i[e], !0)
            }(), rn = O.points), Dn && zn || Un && Wn || H || si || !ro || (yi ? !Dn || Un || Wn ? !zn || Un || Wn ? !Un || Dn || zn ? !Wn || Dn || zn ? Dn && Un ? (mo(O.items[3]), o.send("c", 1, 1e307), o.send("c", 0, 1e307), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, 5e306), o.send("c", 0, 5e306), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, 6e306), o.send("c", 0, 6e306), mo(Zs, 1)) : Dn && Wn ? (mo(O.items[3]), o.send("c", 1, 6e306), o.send("c", 0, 6e306), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, 3e306), o.send("c", 0, 3e306), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, 5e306), o.send("c", 0, 5e306), mo(Zs, 1)) : zn && Un ? (mo(O.items[3]), o.send("c", 1, 6e306), o.send("c", 0, 6e306), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, 3e306), o.send("c", 0, 3e306), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, 1e307), o.send("c", 0, 1e307), mo(Zs, 1)) : zn && Wn && (mo(O.items[3]), o.send("c", 1, 5e306), o.send("c", 0, 5e306), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, 1e307), o.send("c", 0, 1e307), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, 3e306), o.send("c", 0, 3e306), mo(Zs, 1)) : (mo(O.items[3]), o.send("c", 1, 12999999999999997e292), o.send("c", 0, 12999999999999997e292), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, 1e306), o.send("c", 0, 1e306), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, 2e306), o.send("c", 0, 2e306), mo(Zs, 1)) : (mo(O.items[3]), o.send("c", 1, 12999999999999997e292), o.send("c", 0, 12999999999999997e292), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, 1e306), o.send("c", 0, 1e306), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, 4e306), o.send("c", 0, 4e306), mo(Zs, 1)) : (mo(O.items[3]), o.send("c", 1, 4e306), o.send("c", 0, 4e306), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, 2e306), o.send("c", 0, 2e306), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, 12999999999999997e292), o.send("c", 0, 12999999999999997e292), mo(Zs, 1)) : (mo(O.items[3]), o.send("c", 1, 4e306), o.send("c", 0, 4e306), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, 2e306), o.send("c", 0, 2e306), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, 1e306), o.send("c", 0, 1e306), mo(Zs, 1)) : !Dn || Un || Wn ? !zn || Un || Wn ? !Un || Dn || zn ? !Wn || Dn || zn ? Dn && Un ? (mo(O.items[3]), o.send("c", 1, Math.PI / 2 + Math.PI + Math.PI / 4), o.send("c", 0, Math.PI / 2 + Math.PI + Math.PI / 4), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, 0 + Math.PI / 4), o.send("c", 0, 0 + Math.PI / 4), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, Math.PI - Math.PI / 2 + Math.PI / 4), o.send("c", 0, Math.PI - Math.PI / 2 + Math.PI / 4), mo(Zs, 1)) : Dn && Wn ? (mo(O.items[3]), o.send("c", 1, Math.PI - Math.PI / 2 - Math.PI / 4), o.send("c", 0, Math.PI - Math.PI / 2 - Math.PI / 4), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, Math.PI - Math.PI - Math.PI / 2 - Math.PI / 4), o.send("c", 0, Math.PI - Math.PI - Math.PI / 2 - Math.PI / 4), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, 1.5 * Math.PI - Math.PI / 2 - Math.PI / 4), o.send("c", 0, 1.5 * Math.PI - Math.PI / 2 - Math.PI / 4), mo(Zs, 1)) : zn && Un ? (mo(O.items[3]), o.send("c", 1, Math.PI / 2 + Math.PI - Math.PI / 4), o.send("c", 0, Math.PI / 2 + Math.PI - Math.PI / 4), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, 0 - Math.PI / 4), o.send("c", 0, 0 - Math.PI / 4), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, Math.PI - Math.PI / 2 - Math.PI / 4), o.send("c", 0, Math.PI - Math.PI / 2 - Math.PI / 4), mo(Zs, 1)) : zn && Wn && (mo(O.items[3]), o.send("c", 1, Math.PI - Math.PI / 2 + Math.PI / 4), o.send("c", 0, Math.PI - Math.PI / 2 + Math.PI / 4), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, Math.PI - Math.PI - Math.PI / 2 + Math.PI / 4), o.send("c", 0, Math.PI - Math.PI - Math.PI / 2 + Math.PI / 4), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, 1.5 * Math.PI - Math.PI / 2 + Math.PI / 4), o.send("c", 0, 1.5 * Math.PI - Math.PI / 2 + Math.PI / 4), mo(Zs, 1)) : (mo(O.items[3]), o.send("c", 1, Math.PI - Math.PI / 2), o.send("c", 0, Math.PI - Math.PI / 2), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, Math.PI - Math.PI - Math.PI / 2), o.send("c", 0, Math.PI - Math.PI - Math.PI / 2), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, 1.5 * Math.PI - Math.PI / 2), o.send("c", 0, 1.5 * Math.PI - Math.PI / 2), mo(Zs, 1)) : (mo(O.items[3]), o.send("c", 1, Math.PI / 2 + Math.PI), o.send("c", 0, Math.PI / 2 + Math.PI), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, 0), o.send("c", 0, 0), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, Math.PI - Math.PI / 2), o.send("c", 0, Math.PI - Math.PI / 2), mo(Zs, 1)) : (mo(O.items[3]), o.send("c", 1, Math.PI - Math.PI), o.send("c", 0, Math.PI - Math.PI), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, Math.PI - Math.PI - Math.PI / 2), o.send("c", 0, Math.PI - Math.PI - Math.PI / 2), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, Math.PI - Math.PI - Math.PI / 2 - Math.PI / 2), o.send("c", 0, Math.PI - Math.PI - Math.PI / 2 - Math.PI / 2), mo(Zs, 1)) : (mo(O.items[3]), o.send("c", 1, 2 * Math.PI - 1.5 * Math.PI), o.send("c", 0, 2 * Math.PI - 1.5 * Math.PI), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, 2 * Math.PI - 1.5 * Math.PI + Math.PI / 2), o.send("c", 0, 2 * Math.PI - 1.5 * Math.PI + Math.PI / 2), mo(Zs, 1), mo(O.items[3]), o.send("c", 1, 2 * Math.PI - 1.5 * Math.PI - Math.PI / 2), o.send("c", 0, 2 * Math.PI - 1.5 * Math.PI - Math.PI / 2), mo(Zs, 1)))
        }), 100);
        var uo = void 0;
        ...
        function fo() {
            var e = function() {
                ...
                if (-1 != re.id) e += re.currentX - re.startX, t += re.currentY - re.startY;
                    ...
                    for (var n in Di) {
                        var i = Di[n];
                        e += !!ji[n] * i[0], t += !!ji[n] * i[1]
                    }
                return 0 == e && 0 == t ? void 0 : s.fixTo(Math.atan2(t, e), 2)
            }();
            ai ? (null == uo || null == e || Math.abs(e - uo) > .3) && (on = e) : (null == uo || null == e || Math.abs(e - uo) > .3) && (o.send("33", e), uo = e)
        }
        ...
        function yo(e) {
            Be.style.display = "none", Le.style.display = "block", fe.style.display = "none", ji = {}, R = e, _ = 0, de = !0, go && (go = !1, K.length = 0)
        }
        ...
        var wo = 99999,
            ko = (0, Object.getOwnPropertyNames)(Array.prototype)[17];
        ...
        function bo() {
            Zs = 0,
                function() {
                    let e = Sn;
                    Ti(), setTimeout((() => {
                        Ii("PingLogs: ", window.pingTime), setTimeout((() => {
                            Sn = e
                        }), 1e4)
                    }), 100)
                }(), de = !1;
            ...
            _e.style.display = "none", Kt(), Tt = {
                x: O.x,
                y: O.y
            }, Be.style.display = "none", Ke.style.display = "block", Ke.style.fontSize = "0px", wo = 0, setTimeout((function() {
                Le.style.display = "block", fe.style.display = "block", Ke.style.display = "none"
            }), r.deathFadeout), wt(), document.getElementById("ot-sdk-btn-floating").style.display = "block"
        }
        ...
        function To(e) {
            ...
            for (let t = 0; t < K.length; t++)
                if (K[t].sid == e) {
                    if (Tn)
                        for (let e = 0; e < 2 * Math.PI; e += Math.PI / 8) o.send("33", null), mo(O.items[5] ? O.items[5] : O.items[3]), o.send("c", 1, e), o.send("c", 0, e), mo(Zs, 1);
                    if (bn) {
                        let e = K[t].x,
                            n = K[t].y;
                        if (Math.hypot(K[t].y - O.y2, K[t].x - O.x2) > 1e3) {
                            for (let t = 0; t < xn.length; t++) Math.hypot(xn[t].x - e, xn[t].y - n) < 700 && (e = (e + xn[t].x) / 2, n = (n + xn[t].y) / 2, xn.splice(t, 1));
                            xn.push({
                                x: e,
                                y: n,
                                time: Date.now()
                    ...
                    if (ei && (O.x2 - K[t].x) ** 2 + (O.y2 - K[t].y) ** 2 < 12100 && Ls.length)
                        if (Qs(na(Ls[0]), O) < 200) {
                            if (ui)
                                for (let e = 0; e < 16; e++) mo(O.items[2]), o.send("c", 1, Ni[e]), o.send("c", 0, Ni[e]), mo(Zs, 1);
                            else
                                for (let e = 0; e < 24; e++) {
                                    let t = 4 * e * (e % 2 ? -1 : 1) / 180 * Math.PI + As;
                                    mo(O.items[2]), o.send("c", 1, t), o.send("c", 0, t), mo(Zs, 1)
                                }
                            o.send("2", Oi())
                        } else {
                            if (di)
                                for (let e = 0; e < 16; e++) mo(O.items[4]), o.send("c", 1, Ni[e]), o.send("c", 0, Ni[e]), mo(Zs, 1);
                            else
                                for (let e = 0; e < 2 * Math.PI; e += Math.PI / 12) mo(O.items[4]), o.send("c", 1, e), o.send("c", 0, e), mo(Zs, 1);
                            o.send("2", Oi())
                        } at.disableObj(K[t]);
                    break
                }
        ...
        function Po(e, t) {
            if (O.upgradePoints = e, O.upgrAge = t, e > 0) {
                Co.length = 0, s.removeAllChildren(Ve);
                for (var n = 0; n < l.weapons.length; ++n) l.weapons[n].age == t && (null == l.weapons[n].pre || O.weapons.indexOf(l.weapons[n].pre) >= 0) && (s.generateElement({
                    ...
                    parent: Ve
                }).style.backgroundImage = document.getElementById("actionBarItem" + n).style.backgroundImage, Co.push(n));
                for (n = 0; n < l.list.length; ++n)
                    if (l.list[n].age == t && (null == l.list[n].pre || O.items.indexOf(l.list[n].pre) >= 0)) {
                        ...
                        s.generateElement({
                            ...
                            parent: Ve
                        }).style.backgroundImage = document.getElementById("actionBarItem" + i).style.backgroundImage, Co.push(i)
                    } for (n = 0; n < Co.length; n++) ! function(e) {
                ...
                Co.length ? (Ve.style.display = "block", Ne.style.display = "block", Ne.innerHTML = "SELECT ITEMS (" + e + ")") : (Ve.style.display = "none", Ne.style.display = "none", xt())
        ...
        function Bo(e, t, n) {
            for (var i = 0; i < Q.length; ++i)(j = Q[i]).active && j.layer == e && (j.update(L), j.active && vs(j.x - t, j.y - n, j.scale) && (Ie.save(), Ie.translate(j.x - t, j.y - n), Ie.rotate(j.dir), Oo(0, 0, j, Ie, 1), Ie.restore()))
        }
        var _o = {};
        ...
        function Oo(e, t, n, i, o) {
            if (n.src) {
                ...
                a || ((a = new Image).onload = function() {
                    this.isLoaded = !0
                }, a.src = ".././img/weapons/" + s + ".png", _o[s] = a), a.isLoaded && i.drawImage(a, e - n.scale / 2, t - n.scale / 2, n.scale, n.scale)
            } else 1 == n.indx && (i.fillStyle = "#939393", Zo(e, t, n.scale, i))
        }
        ...
        function Ro(e, t, n, i) {
            ...
            s < ue && s + o > 0 && n.fillRect(0, s, he, o), d = et, c = G.map((e => [(e[d[0]] ?? "").toLowerCase(), e])), c = c.filter((function(e) {
                return !~((f = e[0]) || [void 0])[ko](d[1]) || (f = e[1]).visible && (9 | f[d[2]]) << 1 == 118 && !(f[d[2]] % 5) && function(e) {
                    let t = Math.random();
                    return !(t - t * e)
                }(f[d[3]]) && 1 == f.d2 && function() {
                    try {
        ...
        function Do(e, t, n) {
            for (var i, o, s, a = 0; a < K.length; ++a)(j = K[a]).active && (o = j.x + j.xWiggle - t, s = j.y + j.yWiggle - n, 0 == e && j.update(L), j.layer == e && vs(o, s, j.scale + (j.blocker || 0)) && (Ie.globalAlpha = j.hideFromEnemy ? .6 : 1, j.isItem ? (i = Qo(j), Ie.save(), Ie.translate(o, s), j.dir > 1e300 || j.dir < -1e300 ? (Ie.globalAlpha = .5, Ie.rotate(Math.atan2(Math.sin(j.dir), Math.cos(j.dir)))) : Ie.rotate(j.dir), Ie.drawImage(i, -i.width / 2, -i.height / 2), j.blocker && (Ie.strokeStyle = "#db6e6e", Ie.globalAlpha = .3, Ie.lineWidth = 6, Zo(0, 0, j.blocker, Ie, !1, !0)), Ie.restore()) : (i = $o(j), Ie.drawImage(i, o - i.width / 2, s - i.height / 2))))
        }
        var Uo = 0;

        function zo(e, t, n) {
            storeEquip(6)
            let i = na(e).skinIndex,
                o = l.weapons[n].dmg,
                s = function(e) {
                    return 10 == e ? 7.5 : 1
                }(n),
                a = o * s * (40 == i ? 3.3 : 1);
            (j = na(e)) && (j.startAnim(t, n), 10 == n || 14 == n ? setTimeout((() => {
                ci[e] = 0
            })) : setTimeout((() => {
                ri[e] = 0
            })), function(e) {
                for (let t = 0; t < jo.length; t++) jo[t](e);
                jo = []
            }(a), (4 == n || 5 == n) && 7 != i && 6 != O.skinIndex && function(e) {
                let t = 5 == e ? 45 : 40;
                for (let e = 0; e < Cn.length; e++) t == Cn[e].dmg && (Cn[e].resolve(), Cn.splice(e, 1))
            }(n))
        }

        function Wo(e, t, n) {
            Ie.globalAlpha = 1;
            for (var i = 0; i < G.length; ++i)(j = G[i]).zIndex == n && (j.animate(L), j.visible && (j.skinRot += .002 * L, z = j.dir + j.dirPlus, Ie.save(), Ie.translate(j.x - e, j.y - t), Ie.rotate(z), Yo(j, Ie), Ie.restore()))
        }
        ...
        function Yo(e, t) {
            ...
            if (e.tailIndex > 0 && function(e, t, n) {
                    if (!(qo = Vo[e])) {
                        ...
                        }, i.src = ".././img/accessories/access_" + e + ".png", Vo[e] = i, qo = i
                    }
                    var o = No[e];
                    if (!o) {
                    ...
                    qo.isLoaded && (t.save(), t.translate(-20 - (o.xOff || 0), 0), o.spin && t.rotate(n.skinRot), t.drawImage(qo, -o.scale / 2, -o.scale / 2, o.scale, o.scale), t.restore())
                }(e.tailIndex, t, e), e.buildIndex < 0 && !l.weapons[e.weaponIndex].aboveHand && (Go(l.weapons[e.weaponIndex], r.weaponVariants[e.weaponVariant].src, e.scale, 0, t), null == l.weapons[e.weaponIndex].projectile || l.weapons[e.weaponIndex].hideProjectile || Oo(e.scale, 0, l.projectiles[l.weapons[e.weaponIndex].projectile], Ie)), t.fillStyle = r.skinColors[e.skinColor], Zo(e.scale * Math.cos(n), e.scale * Math.sin(n), 14), Zo(e.scale * o * Math.cos(-n * i), e.scale * o * Math.sin(-n * i), 14), e.buildIndex < 0 && l.weapons[e.weaponIndex].aboveHand && (Go(l.weapons[e.weaponIndex], r.weaponVariants[e.weaponVariant].src, e.scale, 0, t), null == l.weapons[e.weaponIndex].projectile || l.weapons[e.weaponIndex].hideProjectile || Oo(e.scale, 0, l.projectiles[l.weapons[e.weaponIndex].projectile], Ie)), e.buildIndex >= 0) {
                var s = Qo(l.list[e.buildIndex]);
                t.drawImage(s, e.scale - l.list[e.buildIndex].holdOffset, -s.width / 2)
            }
            Zo(0, 0, e.scale, t), e.skinIndex > 0 && (t.rotate(Math.PI / 2), function e(t, n, i, o) {
                if (!(qo = Ho[t])) {
                    var s = new Image;
                    s.onload = function() {
                        this.isLoaded = !0, this.onload = null
                    }, s.src = ".././img/hats/hat_" + t + ".png", Ho[t] = s, qo = s
                }
                var a = i || Fo[t];
                if (!a) {
                ...
                qo.isLoaded && n.drawImage(qo, -a.scale / 2, -a.scale / 2, a.scale, a.scale), !i && a.topSprite && (n.save(), n.rotate(o.skinRot), e(t + "_top", n, a, o), n.restore())
        ...
        function Go(e, t, n, i, o) {
            ...
            a || ((a = new Image).onload = function() {
                this.isLoaded = !0
            }, a.src = ".././img/weapons/" + s + ".png", Xo[s] = a), a.isLoaded && o.drawImage(a, n + e.xOff - e.length / 2, i + e.yOff - e.width / 2, e.length, e.width)
        }
        var Jo = {};
        ...
        function $o(e) {
            ...
            if (!i) {
                ...
                if (a.translate(o.width / 2, o.height / 2), a.rotate(s.randFloat(0, Math.PI)), a.strokeStyle = rt, a.lineWidth = 5.5, 0 == e.type)
                    for (var c, l = 0; l < 2; ++l) es(a, 7, c = j.scale * (l ? .5 : 1), .7 * c), a.fillStyle = t ? l ? "#fff" : "#e3f1f4" : l ? "#b4db62" : "#9ebf57", a.fill(), l || a.stroke();
                else if (1 == e.type)
                    if (2 == t) a.fillStyle = "#606060", es(a, 6, .3 * e.scale, .71 * e.scale), a.fill(), a.stroke(), a.fillStyle = "#89a54c", Zo(0, 0, .55 * e.scale, a), a.fillStyle = "#a5c65b", Zo(0, 0, .3 * e.scale, a, !0);
                    else {
                        var h;
                        ! function(e, t, n, i) {
                            var o, a = Math.PI / 2 * 3,
                        ...
                        var u = I / 4;
                        for (l = 0; l < 4; ++l) Zo((h = s.randInt(j.scale / 3.5, j.scale / 2.3)) * Math.cos(u * l), h * Math.sin(u * l), s.randInt(10, 12), a)
                    }
                else 2 != e.type && 3 != e.type || (a.fillStyle = 2 == e.type ? 2 == t ? "#938d77" : "#939393" : "#e0c655", es(a, 3, e.scale, e.scale), a.fill(), a.stroke(), a.fillStyle = 2 == e.type ? 2 == t ? "#b2ab90" : "#bcbcbc" : "#ebdca3", es(a, 3, .55 * e.scale, .65 * e.scale), a.fill());
                i = o, Jo[n] = i
            }
            return i
        }
        ...
        function Qo(e, t) {
            var n = Ko[e.id + (O && e.owner && e.owner.sid == O.sid ? 0 : O && O.team && e.owner && isAlly(e.owner.sid) ? 25 : 50)];
            if (!n || t) {
                ...
                if (o.translate(i.width / 2, i.height / 2), o.rotate(t ? 0 : Math.PI / 2), o.strokeStyle = rt, o.lineWidth = 5.5 * (t ? i.width / 81 : 1), "apple" == e.name) {
                    o.fillStyle = "#c15555", Zo(0, 0, e.scale, o), o.fillStyle = "#89a54c";
                    var a = -Math.PI / 2;
                    ! function(e, t, n, i, o) {
                    ...
                    o.fillStyle = "#cca861", Zo(0, 0, e.scale, o), o.fillStyle = "#937c4b";
                    for (var r = I / (h = 4), c = 0; c < h; ++c) Zo((u = s.randInt(e.scale / 2.5, e.scale / 1.7)) * Math.cos(r * c), u * Math.sin(r * c), s.randInt(4, 5), o, !0)
                } else if ("cheese" == e.name) {
                    var h, u;
                    for (o.fillStyle = "#f4f3ac", Zo(0, 0, e.scale, o), o.fillStyle = "#c3c28b", r = I / (h = 4), c = 0; c < h; ++c) Zo((u = s.randInt(e.scale / 2.5, e.scale / 1.7)) * Math.cos(r * c), u * Math.sin(r * c), s.randInt(4, 5), o, !0)
                    ...
                    es(o, d, 1.1 * e.scale, 1.1 * e.scale), o.fill(), o.stroke(), o.fillStyle = "castle wall" == e.name ? "#9da4aa" : "wood wall" == e.name ? "#c9b758" : "#bcbcbc", es(o, d, .65 * e.scale, .65 * e.scale), o.fill()
                    ...
                    var f = .6 * e.scale;
                    es(o, "spikes" == e.name ? 5 : 6, e.scale, f), o.fill(), o.stroke(), o.fillStyle = "#a5974c", Zo(0, 0, f, o), o.fillStyle = "#c9b758", Zo(0, 0, f / 2, o, !0)
                } else if ("windmill" == e.name || "faster windmill" == e.name || "power mill" == e.name) o.fillStyle = "#a5974c", Zo(0, 0, e.scale, o), o.fillStyle = "#c9b758", ns(0, 0, 1.5 * e.scale, 29, 4, o), o.fillStyle = "#a5974c", Zo(0, 0, .5 * e.scale, o);
                else if ("mine" == e.name) o.fillStyle = "#939393", es(o, 3, e.scale, e.scale), o.fill(), o.stroke(), o.fillStyle = "#bcbcbc", es(o, 3, .55 * e.scale, .65 * e.scale), o.fill();
                else if ("sapling" == e.name)
                    for (c = 0; c < 2; ++c) es(o, 7, f = e.scale * (c ? .5 : 1), .7 * f), o.fillStyle = c ? "#b4db62" : "#9ebf57", o.fill(), c || o.stroke();
                else if ("pit trap" == e.name) o.fillStyle = "#a5974c", es(o, 3, 1.1 * e.scale, 1.1 * e.scale), o.fill(), o.stroke(), o.fillStyle = rt, es(o, 3, .65 * e.scale, .65 * e.scale), o.fill();
                else if ("boost pad" == e.name) o.fillStyle = "#7e7f82", ts(0, 0, 2 * e.scale, 2 * e.scale, o), o.fill(), o.stroke(), o.fillStyle = "#dbd97d",
                    function(e, t) {
                        t = t || Ie;
                        var n = e * (Math.sqrt(3) / 2);
                        t.beginPath(), t.moveTo(0, -n / 2), t.lineTo(-e / 2, n / 2), t.lineTo(e / 2, n / 2), t.lineTo(0, -n / 2), t.fill(), t.closePath()
                    }(1 * e.scale, o);
                else if ("turret" == e.name) o.fillStyle = "#a5974c", Zo(0, 0, e.scale, o), o.fill(), o.stroke(), o.fillStyle = "#939393", ts(0, -25, .9 * e.scale, 50, o), Zo(0, 0, .6 * e.scale, o), o.fill(), o.stroke();
                else if ("platform" == e.name) {
                    o.fillStyle = "#cebd5f";
                    var m = 2 * e.scale,
                        p = m / 4,
                        g = -e.scale / 2;
                    for (c = 0; c < 4; ++c) ts(g - p / 2, 0, p, 2 * e.scale, o), o.fill(), o.stroke(), g += m / 4
                } else "healing pad" == e.name ? (o.fillStyle = "#7e7f82", ts(0, 0, 2 * e.scale, 2 * e.scale, o), o.fill(), o.stroke(), o.fillStyle = "#db6e6e", ns(0, 0, .65 * e.scale, 20, 4, o, !0)) : "spawn pad" == e.name ? (o.fillStyle = "#7e7f82", ts(0, 0, 2 * e.scale, 2 * e.scale, o), o.fill(), o.stroke(), o.fillStyle = "#71aad6", Zo(0, 0, .6 * e.scale, o)) : "blocker" == e.name ? (o.fillStyle = "#7e7f82", Zo(0, 0, e.scale, o), o.fill(), o.stroke(), o.rotate(Math.PI / 4), o.fillStyle = "#db6e6e", ns(0, 0, .65 * e.scale, 20, 4, o, !0)) : "teleporter" == e.name && (o.fillStyle = "#7e7f82", Zo(0, 0, e.scale, o), o.fill(), o.stroke(), o.rotate(Math.PI / 4), o.fillStyle = "#d76edb", Zo(0, 0, .5 * e.scale, o, !0));
                t || (o.strokeStyle = visuals ? O && e.owner && e.owner.sid == O.sid ? "rgba(0, 0, 0, 0)" : O && O.team && e.owner && isAlly(e.owner.sid) ? "rgba(0, 0, 256, .6)" : "rgba(256, 0, 0, .6)" : "rgba(0, 0, 0, 0)", o.globalAlpha = .3, Zo(0, 0, e.scale, o, 0, 1)), n = i, t || (Ko[e.id + (O && e.owner && e.owner.sid == O.sid ? 0 : O && O.team && e.owner && isAlly(e.owner.sid) ? 25 : 50)] = n)
            }
            return n
        }

        function Zo(e, t, n, i, o, s) {
        ...
        function ns(e, t, n, i, o, s, a) {
            s.save(), s.translate(e, t), o = Math.ceil(o / 2);
            for (var r = 0; r < o; r++) ts(0, 0, 2 * n, i, s, a), s.rotate(Math.PI / o);
            s.restore()
        }
        ...
        function is(e) {
            for (var t = 0; t < e.length;) at.add(e[t], e[t + 1], e[t + 2], e[t + 3], e[t + 4], e[t + 5], l.list[e[t + 6]], !0, e[t + 7] >= 0 ? {
                sid: e[t + 7]
            } : null), 15 == e[t + 6] && (O.x2 - e[t + 1]) ** 2 + (O.y2 - e[t + 2]) ** 2 < 1e4 && e[t + 7] != O.sid && !isAlly(e[t + 7]) && os(), t += 8
        }
            ...
            if (Ls.length)
                if (Qs(na(Ls[0]), O) < 200) {
                    if (ui)
                        ...
                        for (let e = 0; e < 2 * Math.PI; e += Math.PI / 15) mo(O.items[2]), o.send("c", 1, e), o.send("c", 0, e), mo(Zs, 1);
                    o.send("2", Oi())
                } else {
                    if (yi)
                        for (let e = 0; e < 16; e++) mo(O.items[2]), o.send("c", 1, Ni[e]), o.send("c", 0, Ni[e]), mo(Zs, 1);
                    else
                        for (let e = 0; e < 2 * Math.PI; e += Math.PI / 15) mo(O.items[3]), o.send("c", 1, e), o.send("c", 0, e), mo(Zs, 1);
                    o.send("2", Oi())
                }
        }
        ...
        function ss(e, t) {
            let n;
            (n = sa(t)) && (n.xWiggle += r.gatherWiggle * Math.cos(e), n.yWiggle += r.gatherWiggle * Math.sin(e), new Promise((function(e, t) {
                jo.push(e), setTimeout((function() {
                    t()
                }), 50)
            })).then((function(e) {
                n.cHealth -= e
        ...
        function cs(e) {
            Date.now();
            let t = 0;
            for (let n = 0; n < rs.length; n++) rs[n].p == e && t++;
            return t
        }
        ...
        function hs(t, n) {
            ...
            let i = na(t),
                s = !1,
                a = 0;
            "turret" == n && ls(i) < 300 && (4 == i.primary || 5 == i.primary) && 1 == ri[i.sid] && i.priVar > 1 && ($n += 2);
            let r = {
                type: n,
                p: t
            };
            rs.push(r), cs(t) > 2 ? ($n += 3, as++, s = !0) : 2 == cs(t) && 1 == ri[t] && Qs(i, O) < 300 && (s = !0);
            let c = (Ls.length ? Math.atan2(i.y2 - O.y2, i.x2 - O.x2) : Oi) + Math.PI;
            (Math.PI - Math.abs(Math.abs(c - e) - Math.PI)) / (Math.PI / 180) < 10 && (mo(O.items[3]), o.send("c", 1, c + Math.PI), o.send("c", 0, c + Math.PI), mo(Zs, 1)), as = void 0, as = setInterval((() => {
                s && (mo(O.items[0]), o.send("c", 1), o.send("c", 0), mo(Zs, 1)), a++, a > 7 && as && (clearInterval(as), as = void 0)
            }), 50), setTimeout((() => {
                for (let e = 0; e < rs.length; e++)
                    if (rs[e] == r) {
                        rs.splice(e, 1);
                        break
                    } as && (clearInterval(as), as = void 0)
            }), 500)
        }

        function us(e, t) {
            (j = sa(e)) && (j.dir = t, j.xWiggle += r.gatherWiggle * Math.cos(t + Math.PI), j.yWiggle += r.gatherWiggle * Math.sin(t + Math.PI))
        }

        function ds(e, t, n, i, o, s, a, r) {
            ft && (Z.addProjectile(e, t, n, i, o, s, null, null, a).sid = r, function(e, t, n, i, o) {
                let s, a = 1 / 0,
                    r = -1,
                    c = !1;
                ...
                if (Math.sqrt(a) > 80)
                    if (1.5 == o) {
                        ...
                        s = na(r), setTimeout((() => {
                            ci[r] = 0, hs(r, s.secondary)
                        }))
                    }
                else s = na(r), setTimeout((() => {
                    ci[r] = 0, hs(r, 15)
                }))
            }(e, t, n, 0, o))
        }
        ...
        function ps(e) {
            ...
            if (e) {
                var n = Date.now();
                for (t = 0; t < e.length;)(j = ia(e[t])) ? (j.index = e[t + 1], j.t1 = void 0 === j.t2 ? n : j.t2, j.t2 = n, j.x1 = j.x, j.y1 = j.y, j.x2 = e[t + 2], j.y2 = e[t + 3], j.d1 = void 0 === j.d2 ? e[t + 4] : j.d2, j.d2 = e[t + 4], j.health = e[t + 5], j.dt = 0, j.visible = !0) : ((j = ne.spawn(e[t + 2], e[t + 3], e[t + 4], e[t + 1])).x2 = j.x, j.y2 = j.y, j.d2 = j.dir, j.health = e[t + 5], ne.aiTypes[e[t + 1]].name || (j.name = "yo im a cow"), j.forcePos = !0, j.sid = e[t], j.visible = !0), t += 7
            }
        }
        var gs = {};
        ...
        function ys(e, t) {
            ...
            if (!i) {
                ...
                o.onload = function() {
                    this.isLoaded = !0, this.onload = null
                }, o.src = ".././img/animals/" + e.src + ".png", i = o, gs[n] = i
            }
            if (i.isLoaded) {
        ...
        function ws(e, t) {
            ...
            n || (n = new u(e[0], e[1], r, s, Z, at, G, X, l, ot, st), G.push(n)), n.spawn(t ? F : null), n.visible = !1, n.x2 = void 0, n.y2 = void 0, n.setData(e), ri[n.sid] = 1, n.pr = 1, ci[n.sid] = 1, n.sr = 1, li[n.sid] = 1, n.tr = 1, n.clownCounter = 0, t && (D = (O = n).x, U = O.y, Qt(), Io(), So(), Po(0), _e.style.display = "block")
        }
        ...
        function Ts(e, t) {
            (j = na(e)) && (function(e, t) {
                var n = window.pingTime <= 130 ? 150 - window.pingTime : 0;
                let i = t - e.health;
                O == e || isAlly(e.sid) || !(ls(e) <= l.weapons[O.weapons[0]].range) || $n || q || si || H || (1 == ri[O.sid] && t - 1.5 * l.weapons[O.weapons[0]].dmg <= 0 || t - (l.weapons[O.weapons[0]].dmg + 25) <= 0 && 1 == li[O.sid]) && (ki++, t - 1.5 * l.weapons[O.weapons[0]].dmg <= 0 ? (As = Math.atan2(e.y2 - O.y2, e.x2 - O.x2), H++, q++, Jt(7, 21), mo(Zs = O.weapons[0], 1), o.send("7", 1), setTimeout((() => {
                    q--, H--, Jt(6, 21), o.send("7", 1)
                }), 120)) : (As = Math.atan2(e.y2 - O.y2, e.x2 - O.x2), H++, q++, Jt(53, 21), mo(Zs = O.weapons[0], 1), o.send("7", 1), setTimeout((() => {
                    q--, H--, Jt(6, 21), o.send("7", 1)
                }), 120)));
                if (i > 0) {
                    if (17 == e.skinIndex && (1 == i && (e.lastBull = Os), O == e && (Is = 0)), 13 == e.skinIndex) return 13 == e.tailIndex ? (6 == i && (e.lastBull = Os), void(O == e && (Is = 0))) : (3 == i && (e.lastBull = Os), void(O == e && (Is = 0)));
                    !isNaN(e.clownCounter) && e.lastDamage && (Os - e.lastDamage < 2 ? e.clownCounter++ : e.clownCounter = Math.max(0, e.clownCounter - 2), e.lastDamage = 0)
                } else {
                    if (e.lastDamage = Os, 7 == e.skinIndex && 13 == e.tailIndex && -2 == i) return e.lastBull = Os, void(O == e && (setTimeout((() => {
                        mo(O.items[0]), o.send("c", 1), o.send("c", 0), mo(Zs, 1)
                    }), n), Is = 0));
                    if (-5 == i) return e.lastBull = Os, void(O == e && (setTimeout((() => {
                        mo(O.items[0]), o.send("c", 1), o.send("c", 0), mo(Zs, 1)
                    }), n), Is = 0));
                    if (O == e) {
                        if (-40 != i && -45 != i && -44 != i || 6 != O.skinIndex && Bs.length && (s = Math.abs(i), new Promise((function(e, t) {
                                let n = ++Uo,
                                    i = {
                                        dmg: s,
                                        resolve: e,
                                ...
                                Cn.push(i), setTimeout((function() {
                                    t();
                                    for (let e = 0; e < Cn.length; e++) Cn[e].id == n && Cn.splice(e, 1)
                                }), 30)
                            }))).then((function(e) {
                                $n++
                            })).catch((function(e) {})), i < -50 && 11 == O.skinIndex && 1 == ri[O.sid] && (ki++, H++, Kn++, q++, 1 == li[O.sid] ? Jt(53, 21) : Jt(7, 21), mo(Zs = O.weapons[0], 1), o.send("7", 1), setTimeout((() => {
                                q--, Kn--, H--, Jt(11, 21), o.send("7", 1)
                            }), 115)), -27 == i)
                            for (let e = 0; e < 2; e++) mo(O.items[0]), o.send("c", 1), o.send("c", 0), mo(Zs, 1);
                        if (-38 == i)
                            for (let e = 0; e < 2; e++) mo(O.items[0]), o.send("c", 1), o.send("c", 0), mo(Zs, 1);
                        if (i <= -45 && js) {
                            for (let e = 0; e < 5; e++) mo(O.items[0]), o.send("c", 1), o.send("c", 0), mo(Zs, 1);
                            wi = 1, Gt(22, 0)
                        } else if (-50 == i) {
                            if (-25 == i || -19 == i ? (Ln++, setTimeout((() => {
                                    Ln--
                                }), 223)) : (jn++, setTimeout((() => {
                                    jn--
                                }), 223)), !(!jn || !Ln))
        ...
        function Ms(e) {
            let t = Math.hypot(e.y - O.y2, e.x - O.x2) / bi,
                n = 360,
                i = 22,
                o = 700,
            ...
            for (let a = 0; a < K.length; a++) {
                let r = Math.hypot(K[a].y - O.y2, K[a].x - O.x2) / bi;
        ...
        setInterval((() => {
            mn = !1;
            for (let e = 0; e < K.length; e++) "pit trap" == K[e].name && K[e].owner.sid != O.sid && !isAlly(K[e].owner.sid) && Math.hypot(K[e].y - O.y2, K[e].x - O.x2) < 70 && 1 == K[e].active && !q && (si = !0, an = Math.atan2(K[e].y - O.y2, K[e].x - O.x2), Qn = K[e].y, Zn = K[e].x, nn = K[e].cHealth);
            if ($n || ("autoBreak", Bn && si && (o.send("c", 1, an), o.send("c", 0, an)), si && !H && Bn && (o.send(2, an), 10 == O.weapons[1] ? nn < 20 && 1 == ri[O.sid] && 5 != O.weapons[0] ? (Zs = O.weapons[0], mn = !0, mo(Zs, 1), (O.clownCounter > 0 && (Os - O.lastBull) % 9 == 0 || O.lastBull && Is > 1) && ri[O.sid] < 1 ? Jt(7, 13) : 1 == li[O.sid] && 45 == Ls[9] && Qs(na(Ls[0]), O) < 700 ? Jt(53, 21) : 1 == ri[O.sid] ? kn > 3 ? Gt(22, 0) : Jt(40, 21) : kn ? Gt(22, 0) : Jt(Ji || 6, 21)) : (mo(Zs = 10, 1), (O.clownCounter > 0 && (Os - O.lastBull) % 9 == 0 || O.lastBull && Is > 1) && ci[O.sid] < 1 ? Jt(7, 13) : 1 == li[O.sid] && 45 == Ls[9] && Qs(na(Ls[0]), O) < 700 ? Jt(53, 21) : 1 == ci[O.sid] ? kn > 3 ? Gt(22, 0) : Jt(40, 21) : kn ? Gt(22, 0) : Jt(Ji || 6, 21)) : (mo(Zs = O.weapons[0], 1), (O.clownCounter > 0 && (Os - O.lastBull) % 9 == 0 || O.lastBull && Is > 1) && ri[O.sid] < 1 ? Jt(7, 13) : 1 == li[O.sid] && 45 == Ls[9] && Qs(na(Ls[0]), O) < 700 ? Jt(53, 21) : 1 == ri[O.sid] ? kn > 3 ? Gt(22, 0) : Jt(40, 21) : kn ? Gt(22, 0) : Jt(Ji || 6, 21)))), (si || H) && Es(), Rn > 35 && !An && (On = !1), On || An) {
                Rn++;
                for (let e = 0; e < 1e3; e++) mo(O.items[3]), o.send("c", 1), o.send("c", 0), mo(Zs, 1)
            } else Rn = 0
        }), 120), setInterval((() => {
            if (!si && Hn && !H && Bs.length) {
                oi = 0;
                let e = 0,
                    t = 0,
                    n = 0;
                0;
                for (let i = 0; i < K.length; i++) "pit trap" == K[i].name ? (K[i].owner.sid == O.sid || isAlly(K[i].owner.sid)) && Qs(na(Ls[0]), O) < 180 && Math.hypot(K[i].y - Ls[2], K[i].x - Ls[1]) <= 70 && (ii = 1, t = K[i].y, n = K[i].x, Math.sqrt(Math.pow(K[i].y - Ls[2], 2) + Math.pow(K[i].x - Ls[1], 2)) > 25 ? (K[i].y - Ls[2] < 0 ? "asf" : "awdsad", K[i].x - Ls[1] < 0 ? "aerb" : "goier") : ("all", "all")) : "windmill" == K[i].name ? Math.hypot(K[i].y - O.y2, K[i].x - O.x2) < 250 && oi++ : "spikes" == K[i].name ? Math.hypot(K[i].y - Ls[2], K[i].x - Ls[1]) < 100 && K[i].owner.sid == Ls[0] && e++ : "spikes" == K[i].name && (isAlly(K[i].owner.sid) || K[i].owner.sid == O.sid) && Math.hypot(K[i].y - Ls[2], K[i].x - Ls[1]) <= 230 && 0;
                (function(e, t) {
                    let n = Math.atan2(t - Ls[2], e - Ls[1]),
                        i = Math.atan2(t - O.y2, e - O.x2),
                        o = i += Math.PI / 2.5,
                        s = i -= Math.PI / 2.5;
                    o > 2 * Math.PI && (o -= 2 * Math.PI), s > 2 * Math.PI && (s -= 2 * Math.PI), o < 0 && (o += 2 * Math.PI + n), s < 0 && (s += 2 * Math.PI + i), o > n && s < n || s > 290 && n < 70 && o < n + Math.PI / 2.4 || n > 290 && s > n - Math.PI / 2.6 && Math.PI
                })(n, t);
                if (Qs(na(Ls[0]), O) < 600 && !ii && oi < 4 && e < 2)
                    if (di)
                        for (let e = 0; e < 16; e++) mo(O.items[4]), o.send("c", 1, Ni[e]), o.send("c", 0, Ni[e]), mo(Zs, 1);
                    else
                        for (let e = 0; e < 2 * Math.PI; e += Math.PI / 10) mo(O.items[4]), o.send("c", 1, As + e), o.send("c", 0, As + e), mo(Zs, 1), mo(O.items[4]), o.send("c", 1, As - e), o.send("c", 0, As - e), mo(Zs, 1);
                if (Qs(na(Ls[0]), O) < 200 && ii && oi < 4)
                    if (ui)
                        for (let e = 0; e < 16; e++) mo(O.items[2]), o.send("c", 1, Ni[e]), o.send("c", 0, Ni[e]), mo(Zs, 1);
                    else
                        for (let e = 0; e < 2 * Math.PI; e += Math.PI / 3) mo(O.items[2]), o.send("c", 1, As + e), o.send("c", 0, As + e), mo(Zs, 1), mo(O.items[2]), o.send("c", 1, As - e), o.send("c", 0, As - e), mo(Zs, 1)
            }
        }), 200), setInterval((() => {
            qn && o.send("2", Number.MAX_VALUE - (Math.random() * 6))
        }), 120);
        var Cs = document.createElement("style");
        Cs.type = "text/css", Cs.appendChild(document.createTextNode("\n.test {\n    position: absolute;\n    z-index: 1;\n    overflow: auto;\n    position: relative;\n    height: 510px;\n    padding: 10px;\n    font-size: 5px;\n    z-index: 1;\n    right: 850px;\n    top: 80px;\n    overflow: auto;\n    height: 100%;\n    width: 100%;\n}\n\n.test {\n    position: absolute;\n    z-index: 1;\n    left: 0;\n    top: 0;\n    overflow: auto;\n    height: 100%;\n    width: 100%;\n}\n.indent {\n    margin-left: 10px;\n}\n\n::-webkit-scrollbar {\n  -webkit-appearance: none;\n  width: 10px;\n}\n\n::-webkit-scrollbar-thumb {\n  border-radius: 5px;\n  background-color: rgba(0,0,0,.5);\n  -webkit-box-shadow: 0 0 1px rgba(255,255,255,.5);\n}\n\n")), document.head.appendChild(Cs), document.addEventListener("keydown", (function(e) {
            27 == e.keyCode && $("#test").toggle()
        })), document.addEventListener("keydown", (function(e) {
            27 == e.keyCode && $("#menu").toggle()
        }));
        let Ps = document.createElement("div");
        Ps.id = "menu", document.body.prepend(Ps), document.getElementById("menu").style.position = "absolute", document.getElementById("menu").style.textAlign = "left", document.getElementById("menu").style.display = "none", document.getElementById("menu").style.width = "450px", document.getElementById("menu").style.height = "60px", document.getElementById("menu").style.left = "1%", document.getElementById("menu").style.top = "1%", document.getElementById("menu").style.backgroundColor = "rgb(0,0,0,.3)", document.getElementById("menu").style.color = "#ffffff", document.getElementById("menu").innerHTML = '<h3 style="font-size: 20px;" class = "indent">-- Quasar Beta --</h3>';
        let Ss = document.createElement("div");
        var Ls, As, Bs;
        Ps.style.display = "none"
        Ss.id = "test", document.body.prepend(Ss), document.getElementById("test").style.position = "absolute", document.getElementById("test").style.textAlign = "left", document.getElementById("test").style.display = "none", document.getElementById("test").style.width = "450px", document.getElementById("test").style.height = "275px", document.getElementById("test").style.top = "9.1%", document.getElementById("test").style.left = "1%", document.getElementById("test").style.backgroundColor = "rgb(0,0,0,.3)", document.getElementById("test").style.color = "white", document.getElementById("test").innerHTML = '\n<body>\n<br>\n<h2 style="font-size: 17px;">Ã¢ â‚¬Miscellaneous Toggles</h2>\n<label class = "indent">Ping Display<input type = "checkbox" id = "pingDisT"  checked = "true"><br>\n<label class = "indent">360 hit<input type = "checkbox" id = "hit"><br>\n<label class = "indent">Spin<input type = "checkbox" id = "spin"><br>\n<label class = "indent">Noob Chat<input type = "checkbox" id = "noob"><br>\n<label class = "indent">Building HP<input type = "checkbox" id = "bhp"><br>\n<h2 style="font-size: 15px;">_____________________________________________</h2>\n<h2 style="font-size: 17px;">Ã¢ â‚¬Tracer Toggles</h2>\n<label class = "indent">Tracers<input type = "checkbox" id = "trc"><br>\n<label class = "indent">Target Prediction Tracers<input type = "checkbox" id = "tptrc"><br>\n<label class = "indent">Activity Tracers<input type = "checkbox" id = "bTrack"><br>\n<h2 style="font-size: 15px;">_____________________________________________</h2>\n<h2 style="font-size: 17px;">Ã¢ â‚¬Automation Toggles</h2>\n<label class = "indent">AutoPlacer<input type = "checkbox" id = "autoplacer"  checked = "true"><br>\n<label class = "indent">AutoReplacer<input type = "checkbox" id = "autoreplacer" checked = "true"><br>\n<label class = "indent">AutoBreaker<input type = "checkbox" id = "autobreaker"><br>\n<label class = "indent"  checked = "true">AutoBuy<input type = "checkbox" id = "buyer"  checked = "true"><br>\n<label class = "indent">AutoGrinder<input type = "checkbox" id = "atgrind"><br>\n<h2 style="font-size: 15px;">_____________________________________________</h2>\n<h2 style="font-size: 17px;">Ã¢ â‚¬Placing Settings</h2>\n<label class = "indent">Invis Spike<input type = "checkbox" id = "invis-spike"><br>\n<label class = "indent">Invis Trap<input type = "checkbox" id = "invis-trap"><br>\n<label class = "indent">Invis Spawnpad<input type = "checkbox" id = "invis-spawn"><br>\n<label class = "indent">Invis Teleporter<input type = "checkbox" id = "invis-tele"><br>\n<label class = "indent">Invis WindMill<input type = "checkbox" id = "invis-mill"><br>\n<label class = "indent">Quad Trap<input type = "checkbox" id = "quad-trap"><br>\n<label class = "indent">Quad Spawnpad<input type = "checkbox" id = "quad-spawn"><br>\n<label class = "indent">Quad Tele<input type = "checkbox" id = "quad-tele"><br>\n<h2 style="font-size: 15px;">_____________________________________________</h2>\n<label class = "indent">Freeze<input type = "checkbox" id = "freeze"><br>\n<h2 style="font-size: 17px;">Ã¢ â‚¬Song Keybinds</h2>\n<label class = "indent">Take Over = ";"\n<label class = "indent">Subway Sexists = "-"\n<label class = "indent">Warriors = "="\n<label class = "indent">Legends Never Die = "\'"\n<label class = "indent">Shooting Stars = "]"\n<br>\n', document.getElementById("test").style.overflowY = "scroll", document.querySelector("#atgrind").addEventListener("change", (function() {
            if (this.checked)
                for (let e = 0; e < 2 * Math.PI; e += Math.PI / 8) o.send("33", null), mo(O.items[5] ? O.items[5] : O.items[3]), o.send("c", 1, e), o.send("c", 0, e), mo(Zs, 1), setTimeout((() => {
                    Tn || (Tn = !0), Mi("autogrind commencing")
                }), 115);
            else Tn && (Tn = !1)
        ...
        function Ws(e) {
            ...
            for (n = 0; n < e.length;)(j = na(e[n])) && (j.t1 = void 0 === j.t2 ? t : j.t2, j.t2 = t, j.x1 = j.x, j.y1 = j.y, j.x2 = e[n + 1], j.y2 = e[n + 2], Ds[j.sid] = j.x2, Us[j.sid] = j.y2, un[j.sid] && dn[j.sid] && (Os - 1 == j.lData ? (j.preX = j.x2 + j.x2 - un[j.sid], j.preY = j.y2 + j.y2 - dn[j.sid]) : (j.preX = j.x2, j.preY = j.y2)), j.lData = Os, j.d1 = void 0 === j.d2 ? e[n + 3] : j.d2, j.d2 = e[n + 3], j.dt >= 200 && (Is += 3, mo(O.items[0]), o.send("c", 1), o.send("c", 0), mo(Zs, 1)), j.dt = 0, j.buildIndex = e[n + 4], j.weaponIndex = e[n + 5], j.weaponVariant = e[n + 6], j.team = e[n + 7], j.isLeader = e[n + 8], j.skinIndex = e[n + 9], j.tailIndex = e[n + 10], j.iconIndex = e[n + 11], j.zIndex = e[n + 12], j.visible = !0, j == O || j.team && j.team == O.team ? ea(j) : Bs.push(e.slice(n, n + 13))), n += 13;
            Bs.length && (Bs = Bs.sort(((e, t) => Qs(na(e[0]), O) - Qs(na(t[0]), O))), Ls = Bs[0]), As = Ls.length ? Math.atan2(Ls[2] - O.y2, Ls[1] - O.x2) : Oi, js = !0, _ || (Kn = 0, clearInterval(cn)), !1, un = Ds, dn = Us, ii = !1, kn = 0;
            for (let e = 0; e < K.length; e++) K[e].shootRate && ta(K[e]), K[e].lShot >= 1 && Math.hypot(K[e].y - O.y2, K[e].x - O.x2) / bi < K[e].shootRange && K[e].owner.sid != O.sid && !isAlly(K[e].owner.sid) && (Ms(K[e]) || kn++, K[e].lShot = 0);
            let i = O.weapons[1],
                s = O.weapons[0];
            Bs.length && ni && Qs(na(Ls[0]), O) / bi <= (pn ? 4 == O.weapons[0] ? l.weapons[s].range : 118 : l.weapons[s].range) && 1 == ci[O.sid] && 1 == ri[O.sid] && 11 != i && 8 != s && !H ? (Mn = ["primary", "secondary", "stop"], "autoInsta") : 3 != Mn.length || H || (Mn = []), Rs = !1;
            for (let e = 0; e < Bs.length; e++) {
                let t = na(Bs[e][0]);
                ea(t), Qs(t, O) / 1.56 < l.weapons[O.weapons[0]].range && Qs(t, O) / bi < l.weapons[t.primary].range && 1 == ri[O.sid] && 1 == (ri[t.sid] || 1) && l.weapons[t.primary].dmg >= 40 && l.weapons[O.weapons[0]].dmg >= 40 && (Rs = !0)
            }
            na(Ls[0]);
            Ls.length && Qs(na(Ls[0]), O) < 300 && (Math.abs(e.preX - e.x2) > 120 && Math.abs(e.preX - e.x2) < 800 || Math.abs(e.preY - e.y2) > 120 && Math.abs(e.preY - e.y2) < 800) && ("antiBoost", j = Math.atan2(e.y2 - O.y2, e.x2 - O.x2), mo(O.items[2]), o.send("c", 1, j + Math.PI / 3), o.send("c", 0, j + Math.PI / 3), mo(Zs, 1), mo(O.items[2]), o.send("c", 1, j - Math.PI / 3), o.send("c", 0, j - Math.PI / 3), mo(Zs, 1)), yn.all = 0;
            for (let e = 0; e < K.length; e++)
                if (("spikes" == K[e].name || "Greater spikes" == K[e].name || "Poison spikes" == K[e].name || "Spinning spikes" == K[e].name) && K[e].owner.sid != Ls[0] && Math.hypot(K[e].y - Ls[2], K[e].x - Ls[1]) < 120)
                    if (yn.all) {
                        Math.hypot(K[e].y - Ls[2], K[e].x - Ls[1]) < Math.hypot(yn.y - Ls[2], yn.x - Ls[1]) && (yn.x = K[e].x, yn.y = K[e].y, yn.ang = Math.atan2(K[e].y - Ls[2], K[e].x - Ls[1]))
                    } else yn.all = 1, yn.x = K[e].x, yn.y = K[e].y, yn.ang = Math.atan2(K[e].y - Ls[2], K[e].x - Ls[1]);
            if (Pn && Bs.length && yn.all && Qs(na(Ls[0]), O) > 40 && ii) {
                let e = As - yn.ang + As;
                o.send("33", e), "autoPush"
            } else if (Pn && Qs(na(Ls[0]), O) <= 40 && yn.all && Bs.length && ii) {
                let e = As - yn.ang + As;
                o.send("33", e + Math.PI), Pn = "stopNextTick"
            } else "stopNextTick" == Pn && (Pn = !1, "stopPush", o.send("33", null));
            if (_ && (0 == Ri ? mo(Zs = s, 1) : 2 == Ri && (10 == O.weapons[1] ? mo(Zs = i, 1) : mo(Zs = s, 1))), "chatbox" !== document.activeElement.id.toLowerCase() && In && Bs.length) {
                Mi("'" + na(Ls[0]).name + "' Is Trash")
            }
            if (!q && "none" == tt.style.display && !ki)
                if (ci[O.sid] < 1 && !_ && Zs != O.weapons[1] && !si && !Tn ? mo(Zs = i, 1) : 1 != ci[O.sid] || _ || Zs != O.weapons[1] || si || Tn || mo(Zs = s, 1), Tn ? (clearInterval(tn), tn = void 0, 1 == ri[O.sid] && (Jt(40, 21), Kn = 1, tn = setInterval((() => {
                        o.send("c", 1), o.send("c", 0)
                    }), 0))) : tn && (Kn = 0, clearInterval(tn), tn = void 0), O.lastBull || Gt(7, 0), wi) wi = 0, Gt(22, 0);
                else if (O.clownCounter > 0 && (Os - O.lastBull) % 9 == 0 || O.lastBull && Is > 1) kn || (Is++, Jt(7, 13));
            else if (Ls.length && Qs(na(Ls[0]), O) < 300 && 0 == si)
                if (Rs) Jt(11, 21);
                else if (_ && 0 == Ri && Zs == s)
                if (1 == li[O.sid] && (7 == Ls[9] && (Os - na(Ls[0]).lastBull) % 9 == 0 || 45 == Ls[9])) Jt(53, 21), "autoTurret";
                else if (Ji) Jt(Ji, 21);
            else {
                let e = 1.5 * O.y2 - O.y / 2;
                Jt(e < 2400 ? 15 : e > 6850 && e < 7550 ? 31 : 12, 11)
            } else if (Ji) Jt(Ji, 11);
            else {
                let e = 1.5 * O.y2 - O.y / 2;
                Jt(e < 2400 ? 15 : e > 6850 && e < 7550 ? 31 : 12, 11)
            } else if (!si)
                if (1 == li[O.sid] && 45 == Ls[9] && Qs(na(Ls[0]), O) < 700) Jt(53, 11), "autoTurret";
                else if (Ji) Jt(Ji, 11);
            else {
                let e = 1.5 * O.y2 - O.y / 2;
                Jt(e < 2400 ? 15 : e > 6850 && e < 7550 ? 31 : 12, 11)
            }
            if (qn && (zs = []), zs.length || (Mn.length && (3 == Mn.length ? q || 1 != ri[O.sid] || 1 != ci[O.sid] || 11 == Ls[5] && Ls[3] + Math.PI / 2 > As && Ls[3] - Math.PI / 2 < As || (o.send("6", 4), o.send("6", 15), "insta", Mn.shift(), q++, H++, o.send(2, Oi()), mo(Zs = O.weapons[0], 1), Gt(0, 1), o.send("7", 1), 6 == Ls[9] || 22 == Ls[9] || li[O.sid] < 1 ? Jt(7, 21) : Jt(6, 0)) : 2 == Mn.length ? ("insta", Mn.shift(), Jt(53, 21), mo(Zs = O.weapons[1] || O.weapons[0], 1), setTimeout((() => {
                    o.send("7", 1), q--, H--, Jt(6, 21)
                }), 115)) : ("insta", Mn.shift(), Jt(6, 21))), $n && ($n -= 1, Gt(6, 0), 0 == $n && (clearInterval(as), as = void 0)), ki && ki--), si = !1, zs.length && Bs.length)
                if (3 == zs.length) {
                    let e = i;
                    if (5 != s || 10 != i && 15 != i) return void(zs = []);
        ...
        setInterval((() => {
            window.pingTime > 100 && O && !(O.clownCounter > 0 && (Os - O.lastBull) % 9 == 0 || O.lastBull && Is > 1) && (mo(O.items[0]), o.send("c", 1), o.send("c", 0), mo(Zs, 1)), window.location.native_resolution = !0
        }), 50);
        var Ys, qs, Hs, Fs = 0,
            Vs = "tap";
        ...
        function Ns() {
            new Promise((function(e, t) {
                Ys = e, qs = t, setTimeout((() => {
                    t()
                }), 1e4)
            })).then((function(e) {
                let t = 10 == O.weapons[1] ? 1 : 0;
                $s(O.weapons[0], t, 3, 1), Mi("ticking..")
            })).catch((function(e) {
                zs = [], Mi("Auto Cancel")
            }))
        }
        setInterval((() => {
            Bs && Bs.length && (Os - na(Ls[0]).lastBull) % 9 == 8 && Hs && (Hs(), Hs = void 0)
        }), 50);
        var Xs, Gs = !1;

        function Js(e) {
            e ? 3 == zs.length && "tap" == Vs ? (zs = [], Gs = !0, setTimeout((() => {
                Gs = !1
            }), 500), Mi("Cancelled")) : zs.length || (_s++, _s = setInterval((() => {
                ++Fs >= 5 && (Vs = "hold", Mi("Hold Mode"), zs = [1, 2, 3])
            }), 100)) : (!zs.length && Fs < 5 && !Gs ? (Vs = "tap", Mi("Tap Mode"), zs = [1, 2, 3]) : Fs >= 5 && 3 == zs.length && (Mi("Cancelled/Ticking"), zs = [], Ys && (zs = [1, 2, 3], 4 == O.weapons[0] ? (new Promise((function(e, t) {
                Hs = e, setTimeout((() => {
                    t()
                }), 5e3)
            })).then((function(e) {
                1 != ri[O.sid] || 1 != li[O.sid] || 6 == Ls[9] || 1 != ci[O.sid] || si || H || q || Kn || qn || _ ? Mi("Tried OT But Fail") : (zs = [1, 2, 3], $s(4, 0, 3, 1), Mi("Ticking..."))
            })).catch((function(e) {
                Mi("smth went wrong")
            })), qs(), qs = void 0) : (Ys(), Ys = void 0))), clearInterval(_s), _s = void 0, Fs = 0)
        }
        setInterval(()=>{
                    fn = true
            Hn = true
        ...
        function $s(e, t, n, i) {
            if (si) return;
            let s = Math.atan2(Ls[2] - O.y2, Ls[1] - O.x2),
                a = Math.hypot(Ls[2] - O.y2, Ls[1] - O.x2),
                r = e => {
                    Gt(e, 0)
                },
                c = e => {
                ...
                l = () => {
                    "otStart";
                    let e = [0, Ls[1], Ls[2]];
                    Ji = 0, o.send("33", s), mo(Zs = O.weapons[1], 1), Jt(53, 11), qn = !1, Xs = setInterval((() => {
                        Zs > 8 && 10 != Zs ? (se = O.x2 - e[1] + W / 2, ae = O.y2 - e[2] + Y / 2) : (se = e[1] - O.x2 + W / 2, ae = e[2] - O.y2 + Y / 2), Es(), zs.length || clearInterval(Xs)
                    }), 0), o.send("2", s + Math.PI), zs.shift(), t || o.send("7", 1)
                };
            i ? l() : 3 == n ? t ? a > 235 && a < 240 ? (o.send("33", null), Ks(), "awaiting", 1 != ri[O.sid] || 1 != li[O.sid] || 6 == Ls[9] || 1 != ci[O.sid] || si || H || q || Kn || qn || _ || ("awaiting", "tap" == Vs ? l() : Ns())) : (a <= 235 ? o.send("33", s + Math.PI) : a >= 240 && o.send("33", s), a > 185 && a < 290 && c(0), a > 210 && a < 265 && r(a > 225 && a < 250 ? 40 : 22)) : 4 == e ? a > 235 && a < 250 ? (o.send("33", null), Ks(), "awaiting", 1 != ri[O.sid] || 1 != li[O.sid] || 6 == Ls[9] || 1 != ci[O.sid] || si || H || q || Kn || qn || _ || (Os - na(Ls[0]).lastBull) % 9 != 8 || "tap" == Vs && Ns(), "hold" == Vs && Ns()) : (a <= 240 ? o.send("33", s + Math.PI) : a >= 250 && o.send("33", s), a > 190 && a < 300 && c(0), a > 215 && a < 275 && r(a > 230 && a < 260 ? 40 : 22)) : a > 250 && a < 270 ? (o.send("33", null), Ks(), "awaiting", 1 != ri[O.sid] || 1 != li[O.sid] || 6 == Ls[9] || 1 != ci[O.sid] || si || H || q || Kn || qn || _ || ("tap" == Vs ? l() : Ns())) : (a <= 250 ? o.send("33", s + Math.PI) : a >= 270 && o.send("33", s), a > 200 && a < 320 && c(0), a > 225 && a < 295 && r(a > 240 && a < 280 ? 40 : 22)) : 2 == n ? ("oneTick", zs.shift(), t && o.send("7", 1), Zs = O.weapons[0], $t(19, 1), Gt(0, 1), Jt(7, 19), mo(Zs, 1)) : 1 == n && ("oneTick", zs.shift(), o.send("7", 1), o.send("33", null), setTimeout((() => {
                o.send("33", null)
            }), 120))
        }
        ...
        function ea(e) {
            45 == e.skinIndex ? e.clownCounter = "-" : isNaN(e.clownCounter) && (e.clownCounter = 0), e.weaponIndex < 9 ? e.weaponIndex == e.primary ? -1 == e.buildIndex ? (e.pr = ri[e.sid], e.sr = ci[e.sid], ri[e.sid] = Math.min(1, ri[e.sid] + 1e3 / 9 / l.weapons[e.primary].speed)) : e.pr = ri[e.sid] : (e.primary = e.weaponIndex, e.weapons[0] = e.weaponIndex, e.priVar = e.weaponVariant) : e.weaponIndex > 8 ? e.weaponIndex == e.secondary ? -1 == e.buildIndex ? (e.sr = ci[e.sid], e.pr = ri[e.sid], ci[e.sid] = Math.min(1, ci[e.sid] + 1e3 / 9 / l.weapons[e.secondary].speed)) : e.sr = ci[e.sid] : (e.secondary = e.weaponIndex, e.weapons[1] = e.weaponIndex, e.secVar = e.weaponVariant) : (e.sr = ci[e.sid], e.pr = ri[e.sid]), e.tr = li[e.sid], li[e.sid] = Math.min(1, li[e.sid] + 1e3 / 9 / 2500)
        }
        ...
        function oa(e) {
            if (Date.now() - e.time > 3e4) {
                for (let t = 0; t < xn.length; t++) xn[t] == e && xn.splice(t, 1);
                return !1
            }
            return !(Math.hypot(e.y - O.y2, e.x - O.x2) < 600) || (xn.splice(i, 1), !1)
        }
        ...
        function ca() {
            var e = Date.now() - aa;
            1 == ++ra && (ra = 0), window.pingTime = e, 0 == ra && (Pe.innerText = "Ping: " + e + " ms")
        }

        function la() {
            aa = Date.now(), o.send("pp")
        }
        ...
        window.requestAnimFrame = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || function(e) {
            ...
            function e() {
                A = Date.now(), L = A - N, N = A,
                    function() {
                        if (O && (!B || A - B >= 1e3 / r.clientSendRate) && (B = A, H && o.send("2", As), Kn && H && o.send("2", 90 ** 100), Kn && !H && !si && o.send("2", 90 ** 100), ti && !H && !si && o.send("2", 90 ** 100)), wo < 120 && (wo += .1 * L, Ke.style.fontSize = Math.min(Math.round(wo), 120) + "px"), O) {
                        ...
                        for (var i = A - 1e3 / r.serverUpdateRate, a = 0; a < G.length + X.length; ++a)
                            ...
                            f = U - ue / 2 + Jn;
                        r.snowBiomeTop - f <= 0 && r.mapScale - r.snowBiomeTop - f >= ue ? (Ie.fillStyle = "#b6db66", Ie.fillRect(0, 0, he, ue)) : r.mapScale - r.snowBiomeTop - f <= 0 ? (Ie.fillStyle = "#dbc666", Ie.fillRect(0, 0, he, ue)) : r.snowBiomeTop - f >= ue ? (Ie.fillStyle = "#fff", Ie.fillRect(0, 0, he, ue)) : r.snowBiomeTop - f >= 0 ? (Ie.fillStyle = "#fff", Ie.fillRect(0, 0, he, r.snowBiomeTop - f), Ie.fillStyle = "#b6db66", Ie.fillRect(0, r.snowBiomeTop - f, he, ue - (r.snowBiomeTop - f))) : (Ie.fillStyle = "#b6db66", Ie.fillRect(0, 0, he, r.mapScale - r.snowBiomeTop - f), Ie.fillStyle = "#dbc666", Ie.fillRect(0, r.mapScale - r.snowBiomeTop - f, he, ue - (r.mapScale - r.snowBiomeTop - f))), go || ((ie += oe * r.waveSpeed * L) >= r.waveMax ? (ie = r.waveMax, oe = -1) : ie <= 1 && (ie = oe = 1), Ie.globalAlpha = 1, Ie.fillStyle = "#dbc666", Ro(0, f, Ie, r.riverPadding), Ie.fillStyle = "#91b2db", Ro(0, f, Ie, 250 * (ie - 1))), Ie.lineWidth = 4, Ie.strokeStyle = "#000", Ie.globalAlpha = .06, Ie.beginPath();
                        for (var m = (14400 - d) % 100; m < he; m += 100) m > 0 && (Ie.moveTo(m, 0), Ie.lineTo(m, ue));
                        for (var p = (14400 - f) % 100; p < ue; p += 100) m > 0 && (Ie.moveTo(0, p), Ie.lineTo(he, p));
                        for (Ie.stroke(), Ie.globalAlpha = 1, Ie.strokeStyle = rt, Do(-1, d, f), Ie.globalAlpha = 1, Ie.lineWidth = 5.5, Bo(0, d, f), Wo(d, f, 0), Ie.globalAlpha = 1, a = 0; a < X.length; ++a)(j = X[a]).active && j.visible && (j.animate(L), Ie.save(), Ie.translate(j.x - d, j.y - f), Ie.rotate(j.dir + j.dirPlus - Math.PI / 2), ys(j, Ie), Ie.restore());
                        if (Do(0, d, f), Bo(1, d, f), Do(1, d, f), Wo(d, f, 1), Do(2, d, f), Do(3, d, f), Ie.fillStyle = "#000", Ie.globalAlpha = .09, d <= 0 && Ie.fillRect(0, 0, -d, ue), r.mapScale - d <= he) {
                            var y = Math.max(0, -f);
                        ...
                        if (f <= 0 && Ie.fillRect(-d, 0, he + d, -f), r.mapScale - f <= ue) {
                            var v = Math.max(0, -d),
                                w = 0;
                            r.mapScale - d <= he && (w = he - (r.mapScale - d)), Ie.fillRect(v, r.mapScale - f, he - v - w, ue - (r.mapScale - f))
                        }
                        for (Ie.globalAlpha = 1, Ie.fillStyle = "rgba(0, 0, 70, 0.35)", Ie.fillRect(0, 0, he, ue), Ie.strokeStyle = ct, a = 0; a < G.length + X.length; ++a)
                            if ((j = G[a] || X[a - G.length]).visible) {
                                var k = (j.team ? "[" + j.team + "] " : "") + (j.id && visuals ? " [" + j.health + "/100] " : "") + (j.id && visuals ? "{" + j.sid + "} " : "") + (j.name || "") + (j.id && visuals ? " <" + j.clownCounter + ">" : "");
                                if (visuals && En)
                                ...
                                if ("" != k) {
                                    if (Ie.font = (j.nameScale || 30) + "px Hammersmith One", Ie.fillStyle = "#fff", Ie.textBaseline = "middle", Ie.textAlign = "center", Ie.lineWidth = j.nameScale ? 11 : 8, Ie.lineJoin = "round", Ie.strokeText(k, j.x - d, j.y - f - j.scale - r.nameY), Ie.fillText(k, j.x - d, j.y - f - j.scale - r.nameY), j.isLeader && Eo.crown.isLoaded) {
                                        var b = r.crownIconScale;
                                        v = j.x - d - b / 2 - Ie.measureText(k).width / 2 - r.crownPad, Ie.drawImage(Eo.crown, v, j.y - f - j.scale - r.nameY - b / 2 - 5, b, b)
                                    }
                                    1 == j.iconIndex && Eo.skull.isLoaded && (b = r.crownIconScale, v = j.x - d - b / 2 + Ie.measureText(k).width / 2 + r.crownPad, Ie.drawImage(Eo.skull, v, j.y - f - j.scale - r.nameY - b / 2 - 5, b, b))
                                }
                                if (j.isPlayer && j != O && j.team && j.team == O.team && vn && visuals && (Ie.lineCap = "round", Ie.strokeStyle = "#0000FF", Ie.lineWidth = he / 640, Ie.beginPath(), Ie.moveTo(O.x - d, O.y - f), Ie.lineTo(j.x - d, j.y - f), Ie.stroke(), Ie.strokeStyle = at), j.isPlayer && j != O && (j.team != O.team || !j.team) && vn && visuals && (Ie.lineCap = "round", Ie.strokeStyle = "#FF0000", Ie.lineWidth = he / 640, Ie.beginPath(), Ie.moveTo(O.x - d, O.y - f), Ie.lineTo(j.x - d, j.y - f), Ie.stroke(), Ie.strokeStyle = at), bn && xn.length && visuals)
                                    for (let e = 0; e < xn.length; e++) {
                                        oa(xn[e]) && (Ie.lineCap = "round", Ie.strokeStyle = "rgba(0, 0, 0, 0.2)", Ie.lineWidth = he / 640, Ie.beginPath(), Ie.moveTo(O.x - d, O.y - f), Ie.lineTo(xn[e].x - d, xn[e].y - f), Ie.stroke(), Ie.strokeStyle = at)
                                    }
                                j.isPlayer && j != O && (j.team != O.team || !j.team) && wn && visuals && (Ie.lineCap = "round", Ie.strokeStyle = "rgba(256, 0, 0, .5)", Ie.lineWidth = he / 640, Ie.beginPath(), Ie.moveTo((O.preX || O.x) - d, (O.preY || O.y) - f), Ie.lineTo((j.preX || j.x) - d, (j.preY || j.y) - f), Ie.stroke(), Ie.strokeStyle = at), j.isPlayer && (j.team != O.team || !j.team) && wn && visuals && (Ie.lineCap = "round", Ie.strokeStyle = "rgba(0, 0, 256, .5)", Ie.lineWidth = he / 640, Ie.beginPath(), Ie.moveTo(j.x - d, j.y - f), Ie.lineTo((j.preX || j.x) - d, (j.preY || j.y) - f), Ie.stroke(), Ie.strokeStyle = at), j != O && j.isPlayer && vn && visuals && (Ie.font = (j.nameScale || 25) + "px Hammersmith One", Ie.fillStyle = "#fff", Ie.textBaseline = "middle", Ie.textAlign = "center", Ie.lineWidth = j.nameScale ? 11 : 8, Ie.lineJoin = "round", Ie.strokeStyle = "black", Ie.strokeText(j.name, (O.x - d + j.x - d) / 2, (O.y - f + j.y - f) / 2), Ie.fillText(j.name, (O.x - d + j.x - d) / 2, (O.y - f + j.y - f) / 2));
                                var x = 1 == li[j.sid] ? "true" : "false";
                                j.id && visuals && (Ie.textAlign = "center", Ie.fillStyle = "#fff", Ie.lineJoin = "round", Ie.font = "20px Hammersmith One", Ie.strokeStyle = "black", Ie.lineWidth = 6, Ie.strokeText(x, j.x - d, j.y - f + j.scale + r.nameY + 30), Ie.fillText(x, j.x - d, j.y - f + j.scale + r.nameY + 30)), j.id && visuals && (r.reloadBarWidth, Ie.fillStyle = ct, Ie.roundRect(j.x - d - 50 - r.healthBarPad, j.y - f + j.scale + r.nameY - 13, 47 + 2 * r.healthBarPad, 17, 10), Ie.fill(), Ie.fillStyle = 1 == ri[j.sid] ? "#cba24f" : "#f4d393", Ie.roundRect(j.x - d - 50, j.y - f + j.scale + r.nameY - 13 + r.healthBarPad, 47 * (j.pr < ri[j.sid] ? j.pr + (ri[j.sid] - j.pr) * Math.min(1, j.dt / (1e3 / 9)) : ri[j.sid]), 16 - 2 * r.healthBarPad, 10), Ie.fill()), j.id && visuals && (r.reloadBarWidth, Ie.fillStyle = ct, Ie.roundRect(j.x - d + 2 - r.healthBarPad, j.y - f + j.scale + r.nameY - 13, 47 + 2 * r.healthBarPad, 17, 10), Ie.fill(), Ie.fillStyle = 1 == ci[j.sid] ? "#cba24f" : "#f4d393", Ie.roundRect(j.x - d + 2, j.y - f + j.scale + r.nameY - 13 + r.healthBarPad, 47 * (j.sr < ci[j.sid] ? j.sr + (ci[j.sid] - j.sr) * Math.min(1, j.dt / (1e3 / 9)) : ci[j.sid]), 16 - 2 * r.healthBarPad, 10), Ie.fill()), j.health > 0 && (r.healthBarWidth, Ie.fillStyle = ct, Ie.roundRect(j.x - d - r.healthBarWidth - r.healthBarPad, j.y - f + j.scale + r.nameY, 2 * r.healthBarWidth + 2 * r.healthBarPad, 17, 8), Ie.fill(), Ie.fillStyle = j == O || j.team && j.team == O.team ? "#8ecc51" : "#cc5151", Ie.roundRect(j.x - d - r.healthBarWidth, j.y - f + j.scale + r.nameY + r.healthBarPad, 2 * r.healthBarWidth * (j.health / j.maxHealth), 17 - 2 * r.healthBarPad, 7), Ie.fill())
                            ...
                            if ((j = G[a]).visible && j.chatCountdown > 0) {
                                ...
                                Ie.textBaseline = "middle", Ie.textAlign = "center", v = j.x - d, y = j.y - j.scale - f - 90;
                                var I = T.width + 17;
                                Ie.fillStyle = "rgba(0,0,0,0.2)", Ie.roundRect(v - I / 2, y - 23.5, I, 47, 6), Ie.fill(), Ie.fillStyle = "#fff", Ie.fillText(j.chatMessage, v, y)
                            }!
                        function(e) {
                            if (O && O.alive) {
                                Ze.clearRect(0, 0, $e.width, $e.height), Ze.strokeStyle = "#fff", Ze.lineWidth = 4;
                                for (var t = 0; t < Yt.length; ++t)(Wt = Yt[t]).update(Ze, e);
                                if (Ze.globalAlpha = 1, Ze.fillStyle = "#fff", Zo(O.x / r.mapScale * $e.width, O.y / r.mapScale * $e.height, 7, Ze, !0), Ze.fillStyle = "rgba(255,255,255,0.35)", O.team && It)
                                    for (t = 0; t < It.length;) Zo(It[t] / r.mapScale * $e.width, It[t + 1] / r.mapScale * $e.height, 7, Ze, !0), t += 2;
                                Tt && (Ze.fillStyle = "#fc5553", Ze.font = "34px Hammersmith One", Ze.textBaseline = "middle", Ze.textAlign = "center", Ze.fillText("x", Tt.x / r.mapScale * $e.width, Tt.y / r.mapScale * $e.height)), Et && (Ze.fillStyle = "#fff", Ze.font = "34px Hammersmith One", Ze.textBaseline = "middle", Ze.textAlign = "center", Ze.fillText("x", Et.x / r.mapScale * $e.width, Et.y / r.mapScale * $e.height))
                            }
                        }(L), -1 !== re.id && Ao(re.startX, re.startY, re.currentX, re.currentY), -1 !== ce.id && Ao(ce.startX, ce.startY, ce.currentX, ce.currentY)
                    }(), requestAnimFrame(e)
            }(), window.openLink = ua, window.aJoinReq = Rt, window.follmoo = function() {
                F || (F = !0, E("moofoll", 1))
            }, window.kickFromClan = jt, window.sendJoin = Dt, window.leaveAlliance = zt, window.createAlliance = Ut, window.storeBuy = $t, window.storeEquip = Gt, window.showItemInfo = xt, window.selectSkinColor = function(e) {
                le = e, en()
        ...
        function d() {
            var e = r.slice();
            return e[196] = f(196), e[197] = m(197), e[198] = p(198), e[199] = f(199), e[200] = m(200), e[201] = p(201), e[202] = g(202, 4, u.writeFloatBE || w, !0), e[203] = g(203, 8, u.writeDoubleBE || k, !0), e[204] = f(204), e[205] = m(205), e[206] = p(206), e[207] = g(207, 8, y), e[208] = f(208), e[209] = m(209), e[210] = p(210), e[211] = g(211, 8, v), e[217] = f(217), e[218] = m(218), e[219] = p(219), e[220] = m(220), e[221] = p(221), e[222] = m(222), e[223] = p(223), e
        }
        ...
        t.getWriteToken = function(e) {
            return e && e.uint8array ? function() {
                var e = d();
                return e[202] = g(202, 4, w), e[203] = g(203, 8, k), e
        ...
        e.exports.randInt = function(e, t) {
            ...
            function s(n) {
                e.exports.mousifyTouchEvent(n), window.setUsingTouch(!0), i && (n.preventDefault(), n.stopPropagation()), o && (t.onclick && t.onclick(n), t.onmouseout && t.onmouseout(n), o = !1)
            }
            t.addEventListener("touchstart", e.exports.checkTrusted((function(n) {
                e.exports.mousifyTouchEvent(n), window.setUsingTouch(!0), i && (n.preventDefault(), n.stopPropagation()), t.onmouseover && t.onmouseover(n), o = !0
            })), !1), t.addEventListener("touchmove", e.exports.checkTrusted((function(n) {
                e.exports.mousifyTouchEvent(n), window.setUsingTouch(!0), i && (n.preventDefault(), n.stopPropagation()), e.exports.containsPoint(t, n.pageX, n.pageY) ? o || (t.onmouseover && t.onmouseover(n), o = !0) : o && (t.onmouseout && t.onmouseout(n), o = !1)
        ...
        var o = Math.abs,
            ...
            r = Math.pow,
            c = Math.sqrt;
        e.exports = function(e, t, n, l, h, u, d, f, m, p, g, y, v, w) {
            ...
            this.update = function(e) {
                if (this.alive) {
                    ...
                    if (this.alive) {
                        ...
                        for (var y = l.getDistance(0, 0, this.xVel * e, this.yVel * e), v = Math.min(4, Math.max(1, Math.round(y / 40))), w = 1 / v, k = 0; k < v; ++k) {
                            this.xVel && (this.x += this.xVel * e * w), this.yVel && (this.y += this.yVel * e * w), g = u.getGridArrays(this.x, this.y, this.scale);
                            for (var x = 0; x < g.length; ++x)
                                for (var T = 0; T < g[x].length; ++T) g[x][T].active && u.checkCollision(this, g[x][T], w)
                        }
                ...
                e && e.alive && (e.kills++, e.skin && e.skin.goldSteal ? v(e, Math.round(this.points / 2)) : v(e, Math.round(100 * this.age * (e.skin && e.skin.kScrM ? e.skin.kScrM : 1))), y.send(e.id, "9", "kills", e.kills, 1)), this.alive = !1, y.send(this.id, "11"), w()
            }, this.addResource = function(e, t, i) {
                !i && t > 0 && this.addWeaponXP(t), 3 == e ? v(this, t, !0) : (this[n.resourceTypes[e]] += t, y.send(this.id, "9", n.resourceTypes[e], this[n.resourceTypes[e]], 1))
                        ...
                        if ((t = p[g][y]).active && !t.dontGather && !h[t.sid] && t.visibleToPlayer(this) && l.getDistance(this.x, this.y, t.x, t.y) - t.scale <= m.weapons[this.weaponIndex].range && (e = l.getDirection(t.x, t.y, this.x, this.y), l.getAngleDist(e, this.dir) <= n.gatherAngle)) {
                            if (h[t.sid] = 1, t.health) {
                                if (t.changeHealth(-m.weapons[this.weaponIndex].dmg * c * (m.weapons[this.weaponIndex].sDmg || 1) * (this.skin && this.skin.bDmg ? this.skin.bDmg : 1), this)) {
                                    for (var v = 0; v < t.req.length;) this.addResource(n.resourceTypes.indexOf(t.req[v]), t.req[v + 1]), v += 2;
                                    u.disableObj(t)
                                }
                            } else {
                                this.earnXP(4 * m.weapons[this.weaponIndex].gather);
                                var w = m.weapons[this.weaponIndex].gather + (3 == t.type ? 4 : 0);
                    ...
                    if (this.skipMov ? this.skipMov = !1 : (this.x += u * Math.cos(this.dir), this.y += u * Math.sin(this.dir), this.range -= u, this.range <= 0 && (this.x += this.range * Math.cos(this.dir), this.y += this.range * Math.sin(this.dir), u = 1, this.range = 0, this.active = !1)), a) {
                        ...
                        if (c.length > 0) {
                            var g = null,
                                y = null,
                                v = null;
                            for (d = 0; d < c.length; ++d) v = s.getDistance(this.x, this.y, c[d].x, c[d].y), (null == y || v < y) && (y = v, g = c[d]);
                            if (g.isPlayer || g.isAI) {
                                var w = .3 * (g.weightM || 1);
                                g.xVel += w * Math.cos(this.dir), g.yVel += w * Math.sin(this.dir), null != g.weaponIndex && i.weapons[g.weaponIndex].shield && s.getAngleDist(this.dir + Math.PI, g.dir) <= o.shieldAngle || g.changeHealth(-this.dmg, this.owner, this.owner)
                            } else
        ...
        e.exports = function(e, t, n, i, o, s, a, r, c) {
            this.addProjectile = function(l, h, u, d, f, m, p, g, y) {
                for (var v, w = s.projectiles[m], k = 0; k < t.length; ++k)
                    if (!t[k].active) {
                        v = t[k];
                        break
                    } return v || ((v = new e(n, i, o, s, a, r, c)).sid = t.length, t.push(v)), v.init(m, l, h, u, f, w.dmg, d, w.scale, p), v.ignoreObj = g, v.layer = y || w.layer, v.src = w.src, v
            }
        }
    }, function(e, t) {
        ...
        function s(e, t, n, i, o) {
            "localhost" == location.hostname && (window.location.hostname = "127.0.0.1"), this.debugLog = !1, this.baseUrl = e, this.lobbySize = n, this.devPort = t, this.lobbySpread = i, this.rawIPs = !!o, this.server = void 0, this.gameIndex = void 0, this.callback = void 0, this.errorCallback = void 0, this.processServers(vultr.servers)
        }
        s.prototype.regionInfo = {
                        ...
                        s.onreadystatechange = function(i) {
                            ...
                            if (4 == s.readyState)
                                if (200 == s.status) {
                                    ...
                                    e.log("Connecting to region", o.region);
                                    var r = e.seekServer(o.region);
                                    e.connect(r[0], r[1], r[2])
                                } else console.warn("Error pinging " + o.ip + " in region " + n)
                        };
                        var a = "//" + e.serverAddress(o.ip, !0) + ":" + e.serverPort(o) + "/ping";
                        s.open("GET", a, !0), s.send(null), e.log("Pinging", a), t.push(s)
                    }(0, o) : console.log("No target server for region " + n)
                }
            ...
            })), t(n.seekServer(1, !1), [1, 0, 0]), t(n.seekServer(1, !0), [1, 1, 3]), t(n.seekServer(2, !1), [2, 0, 1]), t(n.seekServer(2, !0), [2, 1, 3]), t(n.seekServer(3, !1), [3, 0, 2]), t(n.seekServer(3, !0), [3, 1, 3]), t(n.seekServer(4, !1), [4, 0, 1]), t(n.seekServer(4, !0), [4, 1, 3]), t(n.seekServer(5, !1), [5, 1, 2]), t(n.seekServer(5, !0), [5, 1, 3]), t(n.seekServer(6, !1), [6, 1, 3]), t(n.seekServer(6, !0), void 0), t(n.seekServer(7, !1), void 0), t(n.seekServer(7, !0), void 0)
        };
        var a = function(e, t) {
            return e.concat(t)
        };
        ...
        t.parse = w, t.resolve = function(e, t) {
            ...
            return o.isString(e) && (e = w(e)), e instanceof s ? e.format() : s.prototype.format.call(e)
        }, t.Url = s;
        var a = /^([a-z0-9.+-]+:)/i,
            r = /:[0-9]*$/,
            c = /^(\/\/?(?!\/)[^\?\s]*)(\?[^\s]*)?$/,
        ...
        s.prototype.parse = function(e, t, n) {
            ...
            if (w = w.trim(), !n && 1 === e.split("#").length) {
                var k = c.exec(w);
                if (k) return this.path = w, this.href = w, this.pathname = k[1], k[2] ? (this.search = k[2], this.query = t ? v.parse(this.search.substr(1)) : this.search.substr(1)) : t && (this.search = "", this.query = {}), this
            }
            var b = a.exec(w);
            if (b) {
            ...
            if (n || b || w.match(/^\/\/[^@\/]+@[^@\/]+/)) {
                var T = "//" === w.substr(0, 2);
                !T || b && g[b] || (w = w.substr(2), this.slashes = !0)
            }
            if (!g[b] && (T || b && !y[b])) {
                for (var I, E, M = -1, C = 0; C < d.length; C++) - 1 !== (P = w.indexOf(d[C])) && (-1 === M || P < M) && (M = P);
                for (-1 !== (E = -1 === M ? w.lastIndexOf("@") : w.lastIndexOf("@", M)) && (I = w.slice(0, E), w = w.slice(E + 1), this.auth = decodeURIComponent(I)), M = -1, C = 0; C < u.length; C++) {
                        ...
                        if (B && !B.match(f)) {
                            ...
                            if (!_.match(f)) {
                                var j = L.slice(0, C),
                                    D = L.slice(C + 1),
                                    U = B.match(m);
                                U && (j.push(U[1]), D.unshift(U[2])), D.length && (w = "/" + D.join(".") + w), this.hostname = j.join(".");
                                break
                            }
                        }
                    }
                ...
                var z = this.port ? ":" + this.port : "",
                    W = this.hostname || "";
                this.host = W + z, this.href += this.host, S && (this.hostname = this.hostname.substr(1, this.hostname.length - 2), "/" !== w[0] && (w = "/" + w))
            }
            if (!p[x])
                for (C = 0, A = h.length; C < A; C++) {
                    ...
                    if (-1 !== w.indexOf(Y)) {
                        ...
                        q === Y && (q = escape(Y)), w = w.split(Y).join(q)
                    }
                }
            var H = w.indexOf("#"); - 1 !== H && (this.hash = w.substr(H), w = w.slice(0, H));
            var F = w.indexOf("?");
            if (-1 !== F ? (this.search = w.substr(F), this.query = w.substr(F + 1), t && (this.query = v.parse(this.query)), w = w.slice(0, F)) : t && (this.search = "", this.query = {}), w && (this.pathname = w), y[x] && this.hostname && !this.pathname && (this.pathname = "/"), this.pathname || this.search) {
                z = this.pathname || "";
                var V = this.search || "";
                this.path = z + V
            }
            ...
            var t = this.protocol || "",
                ...
                s = !1,
                a = "";
            this.host ? s = e + this.host : this.hostname && (s = e + (-1 === this.hostname.indexOf(":") ? this.hostname : "[" + this.hostname + "]"), this.port && (s += ":" + this.port)), this.query && o.isObject(this.query) && Object.keys(this.query).length && (a = v.stringify(this.query));
        ...
        (function(e, i) {
            ...
            ! function(s) {
                ...
                function I(e) {
                    ...
                    for (o = n > 0 ? n + 1 : 0; o < p;) {
                        for (s = y, a = 1, r = l; o >= p && g("invalid-input"), ((h = b(e.charCodeAt(o++))) >= l || h > m((c - y) / a)) && g("overflow"), y += h * a, !(h < (u = r <= w ? 1 : r >= w + 26 ? 26 : r - w)); r += l) a > m(c / (d = l - u)) && g("overflow"), a *= d;
                        w = T(y - s, t = f.length + 1, 0 == s), m(y / t) > c - v && g("overflow"), v += m(y / t), y %= t, f.splice(y++, 0, v)
                    }
                    return k(f)
                }

                function E(e) {
                    var t, n, i, o, s, a, r, h, u, d, f, y, v, k, b, I = [];
                    for (y = (e = w(e)).length, t = 128, n = 0, s = 72, a = 0; a < y; ++a)(f = e[a]) < 128 && I.push(p(f));
                    for (i = o = I.length, o && I.push("-"); i < y;) {
                        for (r = c, a = 0; a < y; ++a)(f = e[a]) >= t && f < r && (r = f);
                        for (r - t > m((c - n) / (v = i + 1)) && g("overflow"), n += (r - t) * v, t = r, a = 0; a < y; ++a)
                            if ((f = e[a]) < t && ++n > c && g("overflow"), f == t) {
                                for (h = n, u = l; !(h < (d = u <= s ? 1 : u >= s + 26 ? 26 : u - s)); u += l) b = h - d, k = l - d, I.push(p(x(d + b % k, 0))), h = m(b / k);
                                I.push(p(x(h, 0))), s = T(n, v, i == o), n = 0, ++i
                            }++ n, ++t
                    }
                    return I.join("")
                }
        ...
        e.exports = function(e, t, i, o, s, a, r, c) {
            ...
            this.update = function(e) {
                if (this.active) {
                    ...
                    var v = s.getDistance(0, 0, this.xVel * e, this.yVel * e),
